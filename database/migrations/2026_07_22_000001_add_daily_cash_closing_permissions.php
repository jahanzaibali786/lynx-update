...
return new class extends Migration
{
    private array $permissionMap = [
        'manage daily cash closing' => 'manage bank transfer',
        'create daily cash closing' => 'manage bank transfer',
        'show daily cash closing' => 'manage bank transfer',
        'edit daily cash closing' => 'manage bank transfer',
        'delete daily cash closing' => 'manage bank transfer',
        'approve daily cash closing' => 'manage bank transfer',
    ];
    ...
    private function deletePermission(string $permissionName): void
    {
        $permissionId = DB::table('permissions')
            ->where('name', $permissionName)
            ->where('guard_name', 'web')
