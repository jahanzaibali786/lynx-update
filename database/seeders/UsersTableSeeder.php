...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $arrPermissions = [
            ...
            [
                'name' => 'show sale price product & service',
                'guard_name' => 'web',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
                'name' => 'show purchase price product & service',
                'guard_name' => 'web',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
                'name' => 'show quantity product & service',
                'guard_name' => 'web',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
        ...
        $companyPermissions = [
            ...
            ['name' => 'send purchase'],
            ['name' => 'convert purchase to grn'],
            ['name' => 'manage demand order'],
            ['name' => 'create demand order'],
            ['name' => 'show demand order'],
            ['name' => 'edit demand order'],
            ['name' => 'delete demand order'],
            ['name' => 'forward demand order'],
            ['name' => 'approve demand order'],
            ['name' => 'reject demand order'],
            ['name' => 'convert demand order to invoice'],
            ['name' => 'manage grn'],
            ['name' => 'create grn'],
            ['name' => 'show grn'],
            ['name' => 'edit grn'],
