...
@section('action-btn')
    <div class="float-end">
        @can('convert deal to deal')
            @if(!empty($deal))
                <a href="@can('View Deal') @if($deal->is_active) {{route('deals.show',$deal->id)}} @else # @endif @else # @endcan" data-size="lg"  title=" {{__('Already Converted To Deal')}}" class="btn btn-sm btn-primary">
                    <i class="ti ti-exchange"></i>
                </a>
            @else
                <a href="#" data-size="lg" data-url="{{ URL::to('deals/'.$deal->id.'/show_convert') }}"  data-bs-title="{{__('Convert ['.$deal->subject.'] To Deal')}}" class="btn btn-sm btn-primary">
                    <i class="ti ti-exchange"></i>
                </a>
            @endif
        @endcan
        <a href="#" data-url="{{ URL::to('deals/'.$deal->id.'/labels') }}" data-ajax-popup="true" data-size="lg"  data-bs-title="{{__('Label')}}" class="btn btn-sm btn-primary">
            <i class="ti ti-bookmark"></i>
        </a>
        <a href="#" data-size="lg" data-url="{{ route('deals.edit',$deal->id) }}" data-ajax-popup="true"  data-bs-title="{{__('Edit')}}" class="btn btn-sm btn-primary">
                    ...
                    <div id="tasks" class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                @can('create task')
                                    <div class="float-end">
                                        <a href="#" data-size="lg" data-url="{{ route('deals.tasks.create',$deal->id) }}" data-ajax-popup="true"  data-bs-title="{{__('Add Task')}}" class="btn btn-sm btn-primary">
                                            Create
                                        </a>
                                    </div>
                                @endcan
                                                ...
                                                <div class="w-100">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        ...
                                                        @can('edit task')
                                                                ...
                                                                <a href="#" class="" data-bs-toggle="{{__('Edit Task')}}" data-url="{{route('deals.tasks.edit',[$deal->id,$task->id])}}" data-ajax-popup="true"  data-bs-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i></a>
                                                            </div>
                                                            @endcan
                                                            @can('delete task')
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="float-end">
                                                <a data-size="md" data-url="{{ route('deals.users.edit',$deal->id) }}" data-ajax-popup="true"  data-bs-title="{{__('Add User')}}" class="btn btn-sm btn-primary">
                                                    Create
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="float-end">
                                                <a  data-size="md" data-url="{{ route('deals.products.edit',$deal->id) }}" data-ajax-popup="true"  data-bs-title="{{__('Add Product')}}" class="btn btn-sm btn-primary">
                                                    Create
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="float-end">
                                                <a  data-size="md" data-url="{{ route('deals.sources.edit',$deal->id) }}" data-ajax-popup="true"  data-bs-title="{{__('Add Source')}}" class="btn btn-sm btn-primary">
                                                    Create
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="float-end">
                                                <a  data-size="lg" data-url="{{ route('deals.emails.create',$deal->id) }}" data-ajax-popup="true"  data-bs-title="{{__('Create Email')}}" class="btn btn-sm btn-primary">
                                                    Create
                                                </a>
                                            </div>
                                        @endcan
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="float-end">
                                                <a data-size="lg" data-url="{{ route('deals.discussions.create',$deal->id) }}" data-ajax-popup="true"  data-bs-title="{{__('Add Message')}}" class="btn btn-sm btn-primary">
                                                    Create
                                                </a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="float-end">
                                                <a href="#" data-size="md" class="btn btn-primary btn-icon btn-sm"
                                                   ...
                                                   data-bs-placement="top" data-bs-toggle="{{ __('Grammar check with AI') }}">
                                                    <i class="ti ti-rotate"></i> <span>{{__('Grammar check with AI')}}</span>
                                                </a>
                                                <a href="#" data-size="md" class="btn  btn-primary btn-icon btn-sm"
                                                   data-ajax-popup-over="true" data-url="{{ route('generate',['deal']) }}"
                                                   data-bs-placement="top" data-bs-toggle="{{ __('Generate content with AI') }}">
                    ...
                    <div id="calls" class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="float-end">
                                    <a  data-size="lg" data-url="{{ route('deals.calls.create',$deal->id) }}" data-ajax-popup="true"  data-bs-title="{{__('Add Call')}}" class="btn btn-sm btn-primary">
                                        Create
                                    </a>
                                </div>
                                @endcan
                                    ...
                                    @foreach($calls as $call)
                                        <tr>
                                            ...
                                            <td>
                                                @can('edit deal call')
                                                    <div class="action-btn bg-info ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-url="{{ URL::to('deals/'.$deal->id.'/call/'.$call->id.'/edit') }}" data-ajax-popup="true" data-size="xl"  data-bs-title="{{__('Edit')}}" data-bs-toggle="{{__('Edit Call')}}">
