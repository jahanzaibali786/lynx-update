...
{{--                                <sup>--}}
{{--                                    <a href="https://laravel.com/docs/5.4/broadcasting" target="_blank" data-bs-title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">--}}
...
{{--                                <sup>--}}
{{--                                    <a href="https://laravel.com/docs/5.4/cache" target="_blank" data-bs-title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">--}}
{{--                                        <i class="fa fa-info-circle fa-fw" aria-hidden="true"></i>--}}
{{--                                        <span class="sr-only">{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}</span>--}}
{{--                                    </a>--}}
{{--                                </sup>--}}
...
{{--                                <sup>--}}
{{--                                    <a href="https://laravel.com/docs/5.4/session" target="_blank" data-bs-title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">--}}
{{--                                        <i class="fa fa-info-circle fa-fw" aria-hidden="true"></i>--}}
{{--                                        <span class="sr-only">{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}</span>--}}
{{--                                    </a>--}}
{{--                                </sup>--}}
...
{{--                                <sup>--}}
{{--                                    <a href="https://laravel.com/docs/5.4/queues" target="_blank" data-bs-title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">--}}
{{--                                        <i class="fa fa-info-circle fa-fw" aria-hidden="true"></i>--}}
{{--                                        <span class="sr-only">{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}</span>--}}
{{--                                    </a>--}}
{{--                                </sup>--}}
...
{{--                                <sup>--}}
{{--                                    <a href="https://laravel.com/docs/5.4/redis" target="_blank" data-bs-title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">--}}
{{--                                        <i class="fa fa-info-circle fa-fw" aria-hidden="true"></i>--}}
{{--                                        <span class="sr-only">{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}</span>--}}
{{--                                    </a>--}}
{{--                                </sup>--}}
...
{{--                                <sup>--}}
{{--                                    <a href="https://laravel.com/docs/5.4/mail" target="_blank" data-bs-title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">--}}
{{--                                        <i class="fa fa-info-circle fa-fw" aria-hidden="true"></i>--}}
{{--                                        <span class="sr-only">{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}</span>--}}
{{--                                    </a>--}}
{{--                                </sup>--}}
...
{{--                                <sup>--}}
{{--                                    <a href="https://pusher.com/docs/server_api_guide" target="_blank" data-bs-title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">--}}
{{--                                        <i class="fa fa-info-circle fa-fw" aria-hidden="true"></i>--}}
{{--                                        <span class="sr-only">{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}</span>--}}
{{--                                    </a>--}}
{{--                                </sup>--}}
