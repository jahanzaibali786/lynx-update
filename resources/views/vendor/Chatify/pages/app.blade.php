                            ...
                            <div class="m-header">
                                ...
                                <div class="messenger-listView-tabs">
                                    <a href="#" @if($route == 'user') class="active-tab" @endif data-view="users">
                                        ...
                                        {{--                                        <span class="ti ti-clock" data-bs-title="{{__('Recent')}}"></span>--}}
                                    </a>
                                    <a href="#" @if($route == 'group') class="active-tab" @endif data-view="groups">
                                        ...
                                        {{--                                        <span class="ti ti-users" data-bs-title="{{__('Members')}}"></span>--}}
                                    </a>
                                </div>
                            </div>
                            {{-- tabs and lists --}}
...
@if ($color == 'theme-6')
    <style type="text/css">
        ...
        .m-list-active:hover,
        .m-list-active:focus {
            background: linear-gradient(141.55deg, #100773 3.46%, #100773 99.86%), #100773 !important;
        }
        ...
        .messenger-favorites div.avatar {
            box-shadow: 0px 0px 0px 2px #100773 !important;
        }

        .messenger-listView-tabs a,
        .messenger-listView-tabs a:hover,
        .messenger-listView-tabs a:focus {
            color: linear-gradient(141.55deg, #100773 3.46%, #100773 99.86%), #100773 !important;
        }

        .m-header svg {
            color: #100773 !important;
        }

        .active-tab {
            border-bottom: 2px solid #100773 !important;
        }
