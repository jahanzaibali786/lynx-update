                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-3" id="item_type_div">
                            ...
                            {{ Form::select('item_type', $itemTypes, old('item_type', 'inventory_part'), ['class' => 'form-control select', 'id' => 'item_type', 'required' => 'required']) }}
                        </div>
                        ...
                        <div class="form-group col-md-3" id="sku_div">
                            {{ Form::label('sku', __('Product Code / SKU'), ['class' => 'form-label']) }}<span class="text-danger">*</span>
                            {{ Form::text('sku', old('sku'), ['class' => 'form-control', 'required' => 'required']) }}
                        </div>
                        <div class="form-group col-md-3" id="manufacturer_part_number_div">
                            ...
                            {{ Form::text('manufacturer_part_number', old('manufacturer_part_number'), ['class' => 'form-control']) }}
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="form-check mb-0">
                                    ...
                                    {{ Form::checkbox('is_subitem', 1, old('is_subitem'), ['class' => 'form-check-input', 'id' => 'is_subitem' ,'style' => 'margin-left: 10px !important; float: right !important;']) }}
                                </div>
                            </div>
                            {{ Form::select('parent_id', $parentItems, old('parent_id'), ['class' => 'form-control select', 'id' => 'parent_id']) }}
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <img id="image" class="mt-3 d-none" style="width: 120px;" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        {{ Form::textarea('purchase_description', old('purchase_description'), ['class' => 'form-control', 'rows' => 3]) }}
                    </div>
                    <div class="form-group">
                        {{ Form::label('purchase_price', __('Cost'), ['class' => 'form-label']) }}<span class="text-danger">*</span>
                        {{ Form::number('purchase_price', old('purchase_price', 0), ['class' => 'form-control', 'id' => 'purchase_price', 'required' => 'required', 'step' => '0.01']) }}
                    </div>
                    <div class="form-group">
                        {{ Form::label('expense_chartaccount_id', __('COGS Account'), ['class' => 'form-label']) }}<span class="text-danger">*</span>
                        {{ Form::select('expense_chartaccount_id', $expenseChartAccounts, old('expense_chartaccount_id'), ['class' => 'form-control select custom-select', 'id' => 'expense_chartaccount_id', 'required' => 'required']) }}
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        {{ Form::textarea('sales_description', old('sales_description'), ['class' => 'form-control', 'rows' => 3]) }}
                    </div>
                    <div class="form-group">
                        {{ Form::label('sale_price', __('Sales Price'), ['class' => 'form-label']) }}<span class="text-danger">*</span>
                        {{ Form::number('sale_price', old('sale_price', 0), ['class' => 'form-control', 'required' => 'required', 'step' => '0.01']) }}
                    </div>
                    <div class="form-group">
                        {{ Form::label('sale_chartaccount_id', __('Income Account'), ['class' => 'form-label']) }}<span class="text-danger">*</span>
                        {{ Form::select('sale_chartaccount_id', $incomeChartAccounts, old('sale_chartaccount_id'), ['class' => 'form-control select custom-select', 'id' => 'sale_chartaccount_id', 'required' => 'required']) }}
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            {{ Form::select('inventory_asset_account_id', $inventoryAssetAccounts, old('inventory_asset_account_id'), ['class' => 'form-control select custom-select', 'id' => 'inventory_asset_account_id', 'required' => 'required']) }}
                        </div>
