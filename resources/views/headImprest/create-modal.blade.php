    ...
    <div class="row">
        <div class="col-lg-6 col-md-6">
            <div class="form-group">
                ...
                {{ Form::select('branches', $branches, null, ['class' => 'form-control select', 'id' => 'branches']) }}
            </div>
        </div>
        <div class="col-lg-6 col-md-6">
            <div class="form-group">
    ...
    <div class="row mt-3">
        ...
        <div class="col-lg-6 col-md-6">
            <div class="form-group">
                ...
                <span class="text-danger">*</span>
                {{ Form::select('expense_account_id', $chartAccounts, null, ['class' => 'form-control select', 'required' => 'required']) }}
            </div>
        </div>
    </div>
