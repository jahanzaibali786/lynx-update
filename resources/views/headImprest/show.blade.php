...
@section('page-title')
    {{ __('Head Imprest Voucher Detail') }}
@endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a></li>
    <li class="breadcrumb-item"><a href="{{ route('head-imprest-vouchers.index') }}">{{ __('Head Imprest Vouchers') }}</a></li>
                        ...
                        <div class="invoice-print">
                            <div class="row invoice-title mt-2">
                                <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12">
                                    <h2>{{ __('Head Imprest Expense Voucher') }}</h2>
                                </div>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <div class="font-weight-bold">{{ __('Head Imprest Account Summary') }}</div>
