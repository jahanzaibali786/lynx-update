...
@endphp
<!-- [ Main Content ] end -->
<footer class="dash-footer" style="zoom: 75% !important;">
    {{-- <div class="footer-wrapper">
        <div class="py-1">
            <p class="mb-0 text-primary"> &copy;
                {{ date('Y') }} {{ Utility::getValByName('footer_text') ? Utility::getValByName('footer_text') : config('app.name', 'The Lynx School') }}
            </p>
