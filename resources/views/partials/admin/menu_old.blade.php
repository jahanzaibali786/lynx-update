                        ...
                        <li class="dash-item dash-hasmenu">
                            ...
                            <ul id="student_reports" class="dash-submenu">
                                ...
                                @can('view spacetype')
                                    ...
                                    <li class="dash-item ">
                                        <a class="dash-link {{ Request::segment(1) == 'average-monthly-report' ? 'active' : '' }}"
                                            href="{{ route('average_monthly_report') }}">{{ __('Average Monthly Report') }}</a>
                                    </li>
                                @endcan
                                <li class="dash-item ">
                                ...
                                <li class="dash-item ">
                                    <a class="dash-link {{ Request::segment(1) == 'monthlychallanreport' || Request::segment(1) == 'average-monthly-report' ? 'active' : '' }}"
