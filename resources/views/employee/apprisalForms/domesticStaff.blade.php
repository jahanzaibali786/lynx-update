...
<body>
    <div class="form-title">Domestic Staff APPRAISAL FORM "PERIOD 2018"</div>
    ...
    <table border="1" cellpadding="5" cellspacing="0" width="100%">
        <tr bgcolor="#ccffcc">
          <th colspan="7" align="center">PART-A (PERSONAL)</th>
        </tr>
        <tr>
          <th>Sr#</th>
          <th>Areas</th>
        ...
        <tr bgcolor="#ccffcc">
          <th colspan="7" align="center">PART-B (Performance Indicator)</th>
        </tr>
        <tr>
          <td>1</td>
        ...
        <tr>
          <td>7</td>
          <td>Repo among colleagues and staff</td>
          <td></td>
          <td></td>
          <td></td>
          <td></td>
        ...
        <tr>
          <td>10</td>
          <td>Acceptance and management of changes for the betterment of school</td>
          <td></td>
          <td></td>
          <td></td>
          <td></td>
