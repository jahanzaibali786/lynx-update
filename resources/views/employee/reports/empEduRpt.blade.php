...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Employee Qualification Report') }}</li>
@endsection
...
function branchemployees(id) {
    ...
    $.ajax({
        ...
        function printPdf() {
            const form = document.getElementById('empEduRpt');
                ...
                <div class="mt-2" id="multiCollapseExample1">
                    <div class="card">
                        <div class="card-body filter_change">
                            {{ Form::open(['route' => ['empEduRpt'], 'method' => 'GET', 'id' => 'empEduRpt']) }}
                            <div class="row d-flex justify-content-end">
                                ...
                                <div class="col-auto float-end ms-2 mt-4">
                                 <!--   <a href="#" class="btn mx-1 btn-sm btn-outline-primary"
                                    ...
                                    <a href="#" class="btn mx-1 btn-sm btn-outline-primary"
                                        onclick="document.getElementById('empEduRpt').submit(); return false;"
                                         data-bs-title="{{ __('Apply') }}">
                                        <span class="btn-inner--icon">Search</span>
                                    </a>
                                    <a href="{{ route('empEduRpt') }}" class="btn mx-1 btn-sm btn-outline-danger"
                    ...
                    <tbody>
                        @if (!empty($data) && $data->count())
                            ...
                            @foreach ($groupedEmployees as $branchName => $employees)
                                <tr>
                                    <td colspan="8" class="font-weight-bold bg-light">{{ $branchName }}</td>
                                </tr>
