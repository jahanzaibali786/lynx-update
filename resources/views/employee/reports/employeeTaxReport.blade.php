...
@section('page-title')
    {{ __('Employee Tax Report') }}
@endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Dashboard') }}</a></li>
    <li class="breadcrumb-item">{{ __('Employee Tax Report') }}</li>
@endsection
...
@push('script-page')
    ...
    <script>
        ...
        function printPdf() {
            const form = document.getElementById('employeeTaxReport');
...
@section('content')
            ...
            <div class="mt-2" id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body filter_change">
                        {{ Form::open(['route' => ['employeeTaxReport'], 'method' => 'GET', 'id' => 'employeeTaxReport']) }}
                        <div class="row d-flex justify-content-end">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                <div class="btn-box">
                                    ...
                                    {{ Form::date('to_date', request()->input('to_date'), ['class' => 'form-control', 'required']) }}
                                </div>
                            </div>
                            <div class="col-auto float-end ms-2 mt-4">
                                <a href="#" class="btn mx-1 btn-sm btn-outline-primary"
                                    onclick="document.getElementById('employeeTaxReport').submit(); return false;"
                                    data-bs-title="{{ __('Apply') }}">
                                    <span class="btn-inner--icon">Search</span>
                                </a>
                                <a href="{{ route('employeeTaxReport') }}" class="btn mx-1 btn-sm btn-outline-danger"
    ...
    <div class="content" id="report-content">
        <div class="card p-4">
            <p class="title-school"><b>The Lynx School</b></p>
            <p class="title-report"><b>Employee TAX Deduction Report</b></p>
            <p class="branch-info">
                @isset($_GET['branches'])
                    {{ optional(auth()->user()->getBranch($_GET['branches']))->name ?? 'All Branches' }}
                @endisset
            </p>
            ...
            <div class="table-responsive">
                <table class="datatable">
                    ...
                    <tbody>
                        ...
                        {{-- Totals Row --}}
                        <tr class="text-center fw-bold" style="background: #f0f0f0;">
                            <td colspan="7">Total</td>
                            @foreach ($salaryHeads as $head)
                                <td>{{ $totals['heads'][$head->id] }}</td>
                            @endforeach
                            <td>{{ $totals['gross'] }}</td>
                            <td>{{ $totals['it'] }}</td>
                        </tr>
