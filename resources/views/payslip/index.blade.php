                ...
                <div class="d-flex align-items-center justify-content-end">
                    ...
                    <div class="col-auto float-end ms-2 mt-4">
                        <a href="#" class="btn  btn-primary" onclick="document.getElementById('payslip_form').submit(); return false;"
                            data-bs-title="{{ __('payslip') }}" data-bs-title="{{ __('payslip') }}">{{ __('Generate Payslip') }}
                        </a>
                    </div>
                </div>
                {{ Form::close() }}
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <table class="" id="pc-dt-render-column-cells">
                        <thead>
                        ...
                        function renderButton(data, cell, row) {
                            ...
                            if (data != 0) {
                                var payslip =
                                    ...
                                    '/' + datePicker +
                                    '" data-size="md-pdf"  data-ajax-popup="true" class="btn btn-primary" data-bs-toggle="{{ __('Employee Payslip') }}">' +
                                    '{{ __('Payslip') }}' + '</a> ';
                            }
                            ...
                            if (data != 0) {
                                view =
                                    ...
                                    payslip_id +
                                    '"  data-ajax-popup="true" class="view-btn gray-bg" data-bs-toggle="{{ __('View Employee Detail') }}">' +
                                    '{{ __('View') }}' + '</a>';
                            }
                            ...
                            if (data != 0 && status == "UnPaid") {
                                edit =
                                    ...
                                    payslip_id +
                                    '"  data-ajax-popup="true" class="view-btn blue-bg" data-bs-toggle="{{ __('Edit Employee salary') }}">' +
                                    '{{ __('Edit') }}' + '</a>';
                            }
                            ...
                            $.each(data, function (indexInArray, valueOfElement) {
                                ...
                                if (valueOfElement[7] != 0) {
                                    var payslip =
                                        ...
                                        id +
                                        '/' + datePicker +
                                        '" data-size="lg"  data-ajax-popup="true" class=" btn-sm btn btn-warning" data-bs-toggle="{{ __('Employee Payslip') }}">' +
                                        '{{ __('Payslip') }}' + '</a> ';
                                }
                                ...
                                if (valueOfElement[7] != 0 && valueOfElement[6] == "UnPaid") {
                                    var edit =
                                        '<a href="#" data-url="{{ url('payslip/editemployee/') }}/' +
                                        payslip_id +
                                        '"  data-ajax-popup="true" class="btn-sm btn btn-info" data-bs-toggle="{{ __('Edit Employee salary') }}">' +
                                        '{{ __('Edit') }}' + '</a>';
                                } else {
                                    var edit = '';
                                }
