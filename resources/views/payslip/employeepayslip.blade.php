                                    ...
                                    <table class="table table-striped mb-0" id="dataTable1">
                                        ...
                                        @foreach($payslip as $payslip)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" data-url="{{ route('payslip.showemployee',$payslip->id) }}" class="btn btn-sm btn-warning btn-round btn-icon" data-ajax-popup="true"  data-bs-toggle="{{__('View Employee Detail')}}" data-bs-title="{{__('View Employee Detail')}}">
                                                        {{__('View')}}
                                                    </a>
                                                    <a href="#" data-url="{{ route('payslip.pdf',[$payslip->employee_id,$payslip->salary_month]) }}" data-size="md-pdf" class="btn btn-sm btn-info btn-round btn-icon" data-ajax-popup="true"  data-bs-toggle="{{__('Payslip')}}" data-bs-title="{{__('Payslip')}}">
                                                        {{__('Payslip')}}
                                                    </a>
                                                </td>
                                            </tr>
