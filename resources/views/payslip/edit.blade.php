                                        ...
                                        <div class="company-setting-wrap">
                                            ...
                                            <div class="row">
                                                <div class="col-12 text-end mt-1">
                                                    {{ Form::button('Create '.__('Save Change'), ['type' => 'submit','class' => 'btn btn-primary']) }}
                                                </div>
                                            </div>
                                                ...
                                                <table class="table table-striped mb-0" id="allowance-dataTable">
                                                    ...
                                                    @foreach ($allowances as $allowance)
                                                        <tr>
                                                            ...
                                                            <td class="text-end">
                                                                @can('edit allowance')
                                                                    <a href="#" data-url="{{ URL::to('allowance/'.$allowance->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-bs-toggle="{{__('Edit Allowance')}}" class="btn btn-outline-primary btn-sm mr-1"  data-bs-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i> <span>{{__('Edit')}}</span></a>
                                                                @endcan
                                                                @can('delete allowance')
                                                                    <a href="#" class="btn btn-outline-danger btn-sm"  data-bs-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$allowance->id}}').submit();"><i class="ti ti-trash"></i> <span>{{__('Delete')}}</span></a>
                                                ...
                                                <table class="table table-striped mb-0" id="commission-dataTable">
                                                    ...
                                                    @foreach ($commissions as $commission)
                                                        <tr>
                                                            ...
                                                            <td class="text-end">
                                                                @can('edit allowance')
                                                                    <a href="#" data-url="{{ URL::to('commission/'.$commission->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-bs-toggle="{{__('Edit Allowance')}}" class="btn btn-outline-primary btn-sm mr-1"  data-bs-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i> <span>{{__('Edit')}}</span></a>
                                                                @endcan
                                                                @can('delete allowance')
                                                                    <a href="#" class="btn btn-outline-danger btn-sm"  data-bs-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$commission->id}}').submit();"><i class="ti ti-trash"></i> <span>{{__('Delete')}}</span></a>
                                                ...
                                                <table class="table table-striped mb-0" id="loan-dataTable">
                                                    ...
                                                    @foreach ($loans as $loan)
                                                        <tr>
                                                            ...
                                                            <td class="text-end">
                                                                @can('edit loan')
                                                                    <a href="#" data-url="{{ URL::to('loan/'.$loan->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-bs-toggle="{{__('Edit Allowance')}}" class="btn btn-outline-primary btn-sm mr-1"  data-bs-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i> <span>{{__('Edit')}}</span></a>
                                                                @endcan
                                                                @can('delete loan')
                                                                    <a href="#" class="btn btn-outline-danger btn-sm"  data-bs-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$loan->id}}').submit();"><i class="ti ti-trash"></i> <span>{{__('Delete')}}</span></a>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-end">
                                                                ...
                                                                @can('edit saturation deduction')
                                                                    <a href="#" data-url="{{ URL::to('saturationdeduction/'.$saturationdeduction->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-bs-toggle="{{__('Edit Allowance')}}" class="btn btn-outline-primary btn-sm mr-1"  data-bs-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i> <span>{{__('Edit')}}</span></a>
                                                                @endcan
                                                                @can('delete saturation deduction')
                                                                    <a href="#" class="btn btn-outline-danger btn-sm"  data-bs-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$saturationdeduction->id}}').submit();"><i class="ti ti-trash"></i> <span>{{__('Delete')}}</span></a>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-end">
                                                                @can('edit other payment')
                                                                    <a href="#" data-url="{{ URL::to('otherpayment/'.$otherpayment->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-bs-toggle="{{__('Edit Allowance')}}" class="btn btn-outline-primary btn-sm mr-1"  data-bs-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i> <span>{{__('Edit')}}</span></a>
                                                                @endcan
                                                                @can('delete other payment')
                                                                    <a href="#" class="btn btn-outline-danger btn-sm"  data-bs-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$otherpayment->id}}').submit();"><i class="ti ti-trash"></i> <span>{{__('Delete')}}</span></a>
                                                ...
                                                <table class="table table-striped mb-0" id="overtime-dataTable">
                                                    ...
                                                    @foreach ($overtimes as $overtime)
                                                        <tr>
                                                            ...
                                                            <td class="text-end">
                                                                @can('adit allowance')
                                                                    <a href="#" data-url="{{ URL::to('overtime/'.$overtime->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-bs-toggle="{{__('Edit Allowance')}}" class="btn btn-outline-primary btn-sm mr-1"  data-bs-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i> <span>{{__('Edit')}}</span></a>
                                                                @endcan
                                                                @can('delete allowance')
                                                                    <a href="#" class="btn btn-outline-danger btn-sm"  data-bs-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$overtime->id}}').submit();"><i class="ti ti-trash"></i> <span>{{__('Delete')}}</span></a>
