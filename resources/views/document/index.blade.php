...
@section('action-btn')
    <div class="float-end">
        @can('create document type')
            <a href="#" data-url="{{ route('document.create') }}" data-ajax-popup="true" data-bs-toggle="{{__('Create New Document')}}"  data-bs-title="{{__('Create')}}"  class="btn btn-sm btn-primary">
                Create
            </a>
        @endcan
    </div>
                                        ...
                                        <td>
                                            @can('edit document type')
                                                <div class="action-btn bg-primary ms-2">
                                                    <a href="#" class="mx-3 btn btn-sm align-items-center" data-url="{{ URL::to('document/'.$document->id.'/edit') }}" data-ajax-popup="true"  data-bs-toggle="{{__('Edit')}}" data-bs-title="{{__('Edit')}}">
