...
@section('action-btn')
    <div class="float-end">
        <a href="#" data-size="md" data-url="{{ route('lead_stages.create') }}" data-ajax-popup="true"
             data-bs-title="{{ __('Create Lead Stage') }}" class="btn btn-sm btn-primary">
            Create
        </a>
    </div>
@endsection
                                    ...
                                    <ul class="list-unstyled list-group sortable stage">
                                        @foreach ($pipeline['lead_stages'] as $lead_stages)
                                            <li class="d-flex align-items-center justify-content-between list-group-item"
                                                ...
                                                <?php
                                                $array = ['Initial', 'Qualified', 'Tour Schedule', 'Tour Complete', 'Proposal'];
                                                ?>
                                                @if (in_array($lead_stages->name, $array))
                                                    <h6 class="mb-0">
                                                    ...
                                                    <span class="float-end">
                                                        @can('edit lead stage')
                                                            <div class="action-btn bg-info ms-2"><a href="#"
                                                                    ...
                                                                    data-bs-toggle="{{ __('Edit Lead Stages') }}">
