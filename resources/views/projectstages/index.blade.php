...
@section('action-btn')
    @can('create project stage')
        <div class="float-end">
            <a href="#" data-url="{{ route('projectstages.create') }}" data-ajax-popup="true" data-bs-toggle="{{__('Create Project Stage')}}" class="btn btn-xs btn-white btn-icon-only width-auto">Create {{__('Create')}} </a>
        </div>
    @endcan
@endsection
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        @can('edit project stage')
                                            <a href="#" data-url="{{ URL::to('projectstages/'.$projectstage->id.'/edit') }}" data-ajax-popup="true" data-bs-toggle="{{__('Edit Project Stages')}}" class="edit-icon">
