...
@section('action-btn')
    <div class="float-end">
        @can('create payslip type')
            <a href="#" data-url="{{ route('paysliptype.create') }}" data-ajax-popup="true" data-bs-toggle="{{__('Create New Payslip Type')}}"  data-bs-title="{{__('Create')}}"  class="btn btn-sm btn-primary">
                Create
            </a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row d-flex justify-content-end ">
                                    ...
                                    <div class="col-auto float-end ms-2 mt-4">
                                        ...
                                        <a href="{{ route('paysliptype.index') }}" class="btn btn-sm btn-danger" 
                                    ...
                                    <td>
                                        ...
                                        @can('edit payslip type')
                                            <div class="action-btn bg-primary ms-2">
                                                <a href="#" class="mx-3 btn btn-sm align-items-center" data-url="{{ URL::to('paysliptype/'.$paysliptype->id.'/edit') }}" data-ajax-popup="true" data-bs-toggle="{{__('Edit Payslip Type')}}"  data-bs-title="{{__('Edit')}}" data-bs-title="{{__('Edit')}}">
