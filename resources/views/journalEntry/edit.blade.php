            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                        ...
                        {{ Form::text('payee_account_title', null, ['class' => 'form-control', 'placeholder' => __('Enter Account Title')]) }}
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                        {{ Form::label('payee_account_no', __('Payee Account No'), ['class' => 'form-label']) }}
                        {{ Form::text('payee_account_no', null, ['class' => 'form-control', 'placeholder' => __('Enter Account Number')]) }}
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                        {{ Form::label('payee_cnic', __('Payee CNIC'), ['class' => 'form-label']) }}
                        {{ Form::text('payee_cnic', null, ['class' => 'form-control', 'placeholder' => __('12345-1234567-1')]) }}
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                        {{ Form::label('payee_contact', __('Payee Contact'), ['class' => 'form-label']) }}
                        {{ Form::text('payee_contact', null, ['class' => 'form-control', 'placeholder' => __('Enter Contact No')]) }}
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                        {{ Form::label('payee_email', __('Payee Email'), ['class' => 'form-label']) }}
                        {{ Form::email('payee_email', null, ['class' => 'form-control', 'placeholder' => __('Enter Email')]) }}
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                        ...
                        {{ Form::text('receiver_name', null, ['class' => 'form-control', 'placeholder' => __('Enter Receiver Name')]) }}
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                        {{ Form::label('receiver_cnic', __('Receiver CNIC'), ['class' => 'form-label']) }}
                        {{ Form::text('receiver_cnic', null, ['class' => 'form-control', 'placeholder' => __('12345-1234567-1')]) }}
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                        {{ Form::label('receiver_contact', __('Receiver Contact'), ['class' => 'form-label']) }}
                        {{ Form::text('receiver_contact', null, ['class' => 'form-control', 'placeholder' => __('Enter Contact No')]) }}
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="form-group">
                        {{ Form::label('receiver_email', __('Receiver Email'), ['class' => 'form-label']) }}
                        {{ Form::email('receiver_email', null, ['class' => 'form-control', 'placeholder' => __('Enter Email')]) }}
                    </div>
                </div>
                <div class="col-lg-8 col-md-6"></div>
                <div class="col-lg-12 col-md-12"><hr></div>
...
{{--                                </td>--}}
                                ...
                                <td>
                                    <a href="#" class="ti ti-trash text-white repeater-action-btn bg-danger ms-2 text-danger" data-repeater-delete></a>
                                </td>
                            </tr>
                            </tbody>
                            <tfoot>
