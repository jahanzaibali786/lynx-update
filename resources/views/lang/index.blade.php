        ...
        @if($currantLang != (!empty( $settings['default_language']) ?  $settings['default_language'] : 'en'))
            <div class="action-btn pb-0">
                <div class="form-check form-switch custom-switch-v1 mb-0">
                    ...
                    <input type="checkbox" class="form-check-input input-primary" name="disable_lang" data-bs-placement="top" data-bs-title="{{ __('Enable/Disable') }}" id="disable_lang"  {{ !in_array($currantLang,$disabledLang) ? 'checked':'' }} >
            ...
            <div class="action-btn bg-danger ">
                ...
                <a href="#!" class="btn btn-sm btn-danger btn-icon bs-pass-para"  data-bs-title="{{ __('Delete') }}">
