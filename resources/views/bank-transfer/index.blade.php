                        ...
                        <div class="col-auto mt-4">
                            <div class="row">
                                <div class="col-auto">
                                    ...
                                    <a href="{{route('bank-transfer.index')}}" class="btn mx-1 btn-sm btn-outline-danger "
                                         title="{{ __('Reset') }}"
            ...
            <td class="Action">
                <span>
                    ...
                    <div class="action-btn">
                        ...
                        @endcan
                        @can('delete transfer')
                        {!! Form::open(['method' => 'DELETE', 'route' => ['bank-transfer.destroy',
                        $transfer->id],'id'=>'delete-form-'.$transfer->id]) !!}
