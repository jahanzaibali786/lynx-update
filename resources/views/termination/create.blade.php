...
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-lg-6 col-md-6">
            ...
            {{ Form::select('employee_id', $employees,null, array('class' => 'form-control select custom-select','required'=>'required')) }}
        </div>
        <div class="form-group col-lg-6 col-md-6">
        ...
        <div class="form-group col-lg-6 col-md-6">
         ...
         <div class="form-group col-lg-12 col-md-12" id="editor-container">
