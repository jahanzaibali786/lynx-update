...
@section('action-btn')
    <div class="float-end">
        @can('create barcode')
            <a href="{{ route('pos.print') }}" class="btn btn-sm btn-primary"  data-bs-title="{{__('Print Barcode')}}">
                <i class="ti ti-scan text-white"></i>
            </a>
            <a data-url="{{ route('pos.setting') }}" data-ajax-popup="true"  data-bs-toggle="{{__('Barcode Setting')}}" data-bs-title="{{__('Barcode Setting')}}" class="btn btn-sm btn-primary">
