<div class="card" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="{{ route('sops.index') }}" class="list-group-item list-group-item-action border-0 {{ (request()->is('sops*') ? 'active' : '')}}">{{__('SOP')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
