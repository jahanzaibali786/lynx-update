<div class="card" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="{{ route('product-sub-category.index') }}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'product-sub-category.index' ) ? 'active' : '' }}">{{__('Sub Category')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
