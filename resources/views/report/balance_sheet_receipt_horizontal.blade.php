                                            ...
                                            @if ($accounts != [] && $type != 'Assets')
                                                <div class="account-main-inner py-2">
                                                        ...
                                                        <div class="border-bottom py-2">
                                                            ...
                                                            <div
                                                                ...
                                                                <p class="fw-bold mb-2 text-end me-3">
                                                                    {{ end($account['account']) == true ? $alltotBalance : 0 }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div
                                                        ...
                                                        @endphp
                                                        <h6 class="fw-bold mb-0 text-end me-3">{{ $subtotBalance }}</h6>
                                                    </div>
                                                    @php
                                                        if ($type != 'Assets') {
                                                            $totalAmount += $total;
                            ...
                            @endphp
                                ...
                                <div class="col-md-6">
                                                ...
                                                @foreach ($accounts as $account)
                                                    <div class="border-bottom py-2">
                                                        ...
                                                        <div
                                                            ...
                                                            @endphp
                                                            <p class="fw-bold mb-2 text-end me-3">
                                                                {{ end($account['account']) == true ? $allastotBalance : 0 }}
                                                            </p>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between border-bottom py-2 px-0">
                                        ...
                                        @endphp
                                        <h6 class="fw-bold mb-0 text-end me-3">{{ $subastotBalance }}</h6>
                                    </div>
