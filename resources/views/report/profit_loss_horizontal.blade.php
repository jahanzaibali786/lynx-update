...
@section('action-btn')
    ...
    <div class="float-end me-2">
        <a href="{{ route('report.profit.loss', 'vertical') }}" class="btn mx-1 btn-sm btn-outline-primary" 
            title="{{ __('Verical View') }}" data-original-title="{{ __('Verical View') }}"><span class="btn-inner--icon"><i
