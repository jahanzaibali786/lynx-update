...
@section('action-btn')
    <div class="float-end">
        ...
        <button type="submit" class="btn mx-1 btn-sm btn-outline-primary" 
            data-bs-title="{{ __('Print') }}"><span class="btn-inner--icon">Print</span></button>
        {{ Form::close() }}
    </div>
    ...
    <div class="float-end me-2" id="filter">
        <button id="filter" class="btn mx-1 btn-sm btn-outline-primary"  data-bs-title="filter"><span class="btn-inner--icon">Filters</span></button>
    </div>

    <div class="float-end me-2">
        <a href="{{ route('report.profit.loss', 'horizontal') }}" class="btn mx-1 btn-sm btn-outline-primary"
            
            data-bs-title="{{ __('Horizontal View') }}"><span class="btn-inner--icon"><i
                    class="ti ti-separator-vertical"></i></span></a>
    </div>
@endsection
