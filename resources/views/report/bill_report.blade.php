...
@push('script-page')
    ...
    <script>
        function branchvender(id) {
            var vender = $('#venderselect').val();
            $.ajax({
                    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                    url: "{{ route('branch.vendor') }}",
                    type: "POST",
                    data: {id: id},
                    dataType: 'json',
...
{{--        </a>--}}
        ...
        <a href="#" class="btn mx-1 btn-sm btn-outline-primary" onclick="saveAsPDF()" data-bs-title="{{__('Download')}}" data-bs-title="{{__('Download')}}">
                        ...
                        <div class="row d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12 col-12 mr-2">
                                <div class="btn-box">
                                    ...
                                    {{ Form::select('branch', $branches, isset($_GET['branch']) ? $_GET['branch'] : '', ['class' => 'form-control select', 'onchange' => 'branchvender(this.value)']) }}
                                </div>
                            ...
                            @endif
                                ...
                                {{ Form::select('vender',$vender,isset($_GET['vender'])?$_GET['vender']:'', array('class' => 'form-control select','id' => 'venderselect')) }}
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                ...
                                <a href="#" class="btn mx-1 btn-sm btn-outline-primary" onclick="document.getElementById('report_bill_summary').submit(); return false;"  data-bs-title="{{__('Apply')}}" data-bs-title="{{__('apply')}}">
                                    <span class="btn-inner--icon">Search</span>
                                </a>
                                <a href="{{route('report.bill.summary')}}" class="btn mx-1 btn-sm btn-outline-danger "   data-bs-title="{{ __('Reset') }}" data-bs-title="{{__('Reset')}}">
