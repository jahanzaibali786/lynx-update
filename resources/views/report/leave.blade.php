...
@section('action-btn')
    <div class="float-end">
{{--        <a href="{{ route('leave.export') }}"  data-bs-title="{{ __('Export') }}"--}}
{{--           class="btn btn-sm btn-primary">--}}
{{--            Export--}}
{{--        </a>--}}

        <a href="#" class="btn btn-sm btn-primary" onclick="saveAsPDF()" data-bs-title="{{__('Download')}}" data-bs-title="{{__('Download')}}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row align-items-center justify-content-end">
                            ...
                            <div class="col-auto mt-4">
                                <div class="row">
                                    <div class="col-auto">
                                        <a href="#" class="btn btn-sm btn-primary" onclick="document.getElementById('report_leave').submit(); return false;"  data-bs-title="{{__('Apply')}}" data-bs-title="{{__('apply')}}">
                                            <span class="btn-inner--icon">Search</span>
                                        </a>
                                        <a href="{{route('report.leave')}}" class="btn btn-sm btn-danger "   data-bs-title="{{ __('Reset') }}" data-bs-title="{{__('Reset')}}">
    ...
    <div id="printableArea" class="">
        ...
        <div class="row">
            <div class="col">
                            ...
                            <table class=" mb-0" id="report-dataTable">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="m-view-btn badge bg-info p-2 px-3 rounded">{{$leave['approved']}}
                                                <a href="#" class="text-white" data-url="{{ route('report.employee.leave',[$leave['id'],'Approved',isset($_GET['type']) ?$_GET['type']:'no',isset($_GET['month'])?$_GET['month']:date('Y-m'),isset($_GET['year'])?$_GET['year']:date('Y')]) }}" data-ajax-popup="true" data-bs-toggle="{{__('Approved Leave Detail')}}"  data-bs-title="{{__('View')}}" data-bs-title="{{__('View')}}">{{__('View')}}</a>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="m-view-btn badge bg-danger p-2 px-3 rounded">{{$leave['reject']}}
                                                <a href="#" class="text-white" data-url="{{ route('report.employee.leave',[$leave['id'],'Reject',isset($_GET['type']) ?$_GET['type']:'no',isset($_GET['month'])?$_GET['month']:date('Y-m'),isset($_GET['year'])?$_GET['year']:date('Y')]) }}" class="table-action table-action-delete" data-ajax-popup="true" data-bs-toggle="{{__('Rejected Leave Detail')}}"  data-bs-title="{{__('View')}}" data-bs-title="{{__('View')}}">{{__('View')}}</a>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="m-view-btn badge bg-warning p-2 px-3 rounded">{{$leave['pending']}}
                                                <a href="#" class="text-white" data-url="{{ route('report.employee.leave',[$leave['id'],'Pending',isset($_GET['type']) ?$_GET['type']:'no',isset($_GET['month'])?$_GET['month']:date('Y-m'),isset($_GET['year'])?$_GET['year']:date('Y')]) }}" class="table-action table-action-delete" data-ajax-popup="true" data-bs-toggle="{{__('Pending Leave Detail')}}"  data-bs-title="{{__('View')}}" data-bs-title="{{__('View')}}">{{__('View')}}</a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
