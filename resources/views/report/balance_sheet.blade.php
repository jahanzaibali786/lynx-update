...
@section('action-btn')
    ...
    <div class="float-end me-2" id="filter">
        <button id="filter" class="btn mx-1 btn-sm btn-outline-primary"><span class="btn-inner--icon">Filters</span></button>
    </div>

    <div class="float-end me-2">
        <a href="{{ route('report.balance.sheet' , 'horizontal')}}" class="btn mx-1 btn-sm btn-outline-primary"  title="{{ __('Horizontal View') }}"
            data-original-title="{{ __('Horizontal View') }}"><span class="btn-inner--icon"><i class="ti ti-separator-vertical"></i></span></a>
    </div>
@endsection
@section('content')
    <div class="mt-4">
                                        ...
                                        <tbody>
                                            @foreach ($account['account'] as $record)
                                                @php
                                                    ...
                                                    $Balance = App\Models\Utility::getAccountBalance($getAccount->id, $filter['startDateRange'], $filter['endDateRange'] ,$filter['branch']);
                                ...
                                <div class="account-main-inner py-2">
                                        ...
                                        <div class="border-bottom py-2">
                                            ...
                                            <div
                                                ...
                                                <p class="fw-bold mb-2 text-end">
                                                    ...
                                                    @endphp
                                                    {{ end($account['account']) == true ? $alltotBalance : \Auth::user()->priceFormat(0) }}
                                                </p>
                                            </div>
                                        </div>
                                    ...
                                    <div
                                        ...
                                        <h6 class="fw-bold mb-0">{{ 'Total for ' . $type }}</h6>
                                            ...
                                            @endphp
                                        <h6 class="fw-bold mb-0 text-end">{{ \Auth::user()->priceFormat($subtotBalance) }}</h6>
                                    </div>
                                    @php
                                        if ($type != 'Assets') {
                                            $totalAmount += $total;
