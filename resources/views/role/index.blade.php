                                    ...
                                    <tr class="font-style">
                                        ...
                                        <span class="d-flex">
                                            @can('edit role')
                                                ...
                                                <a href="#" class="btn mx-1 btn-sm btn-outline-primary align-items-center" data-url="{{ route('roles.edit',$role->id) }}" data-ajax-popup="true"  data-size="lg"  data-bs-title="{{__('Edit')}}" data-bs-toggle="{{__('Role Edit')}}">
                                            ...
                                            @if($role->name != 'Employee')
                                                @can('delete role')
                                                    {{-- <div class="action-btn bg-danger ms-2"> --}}
                                                        ...
                                                        <a href="#" class="btn mx-1 btn-sm btn-outline-danger align-items-center"  data-bs-title="{{__('Delete')}}" ><i class="ti ti-trash text-white"></i></a>
                                                        {!! Form::close() !!}
                                                     {{-- </div> --}}
                                                @endcan
                                                @endif
