...
@section('action-btn')
    <div class="float-end">
        @if($view == 'grid')
            <a href="{{ route('projects.list','list') }}"   data-bs-title="{{__('List View')}}" class="btn btn-sm btn-primary">
                <i class="ti ti-list"></i>
            </a>
        @else
            <a href="{{ route('projects.index') }}"   data-bs-title="{{__('Grid View')}}" class="btn btn-sm btn-primary">
        ...
        @can('create project')
            <a href="#" data-size="lg" data-url="{{ route('projects.create') }}" data-ajax-popup="true"  data-bs-title="{{__('Create New Project')}}" data-bs-toggle="{{__('Create Project')}}" class="btn btn-sm btn-primary">
                Create
            </a>
        @endcan
    </div>
