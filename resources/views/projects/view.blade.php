...
@section('action-btn')
    <div class="float-end">
        @can('share project')
            <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true" data-size="md" data-bs-toggle="{{ __('Shared Project Settings') }}"
               data-url="{{route('projects.copylink.setting.create',[ $project->id])}}"
                data-bs-title="{{ __('Shared project settings') }}">
...
{{--               onclick="copyToClipboard(this)"  data-bs-title="{{__('Click to copy link')}}">--}}
...
{{--            </a>--}}
        ...
        @endcan
        @can('edit project')
            <a href="#" data-size="lg" data-url="{{ route('projects.edit', $project->id) }}" data-ajax-popup="true"  data-bs-title="{{__('Edit Project')}}" class="btn btn-sm btn-primary">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        @can('edit project')
                            <div class="float-end">
                                <a href="#" data-size="lg" data-url="{{ route('invite.project.member.view', $project->id) }}" data-ajax-popup="true"  title="" class="btn btn-sm btn-primary" data-bs-title="{{__('Add Member')}}">
                                    Create
                                </a>
                            </div>
                        @endcan
                ...
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        @can('create milestone')
                            <div class="float-end">
                                <a href="#" data-size="md" data-url="{{ route('project.milestone', $project->id) }}" data-ajax-popup="true"  title="" class="btn btn-sm btn-primary" data-bs-title="{{__('Create Milestone')}}">
                                    Create
                                </a>
                            </div>
                        @endcan
                                        ...
                                        <div class="col-sm-auto text-sm-end d-flex align-items-center">
                                            @can('view milestone')
                                                <div class="action-btn bg-warning ms-2">
                                                    <a href="#" data-size="lg" data-url="{{ route('project.milestone.show',$milestone->id) }}" data-ajax-popup="true"  data-bs-title="{{__('View')}}" class="btn btn-sm">
                                            ...
                                            @can('edit milestone')
                                                <div class="action-btn bg-info ms-2">
                                                    <a href="#" data-size="md" data-url="{{ route('project.milestone.edit',$milestone->id) }}" data-ajax-popup="true"  data-bs-title="{{__('Edit')}}" data-bs-toggle="{{__('Edit Milestone')}}"class="btn btn-sm">
                                ...
                                <li class="list-group-item px-0">
                                    <div class="row align-items-center justify-content-between">
                                        ...
                                        <div class="col-auto text-sm-end d-flex align-items-center">
                                            <div class="action-btn bg-info ms-2">
                                                <a href="{{asset(Storage::url('tasks/'.$attachment->file))}}"   data-bs-title="{{__('Download')}}" class="btn btn-sm" download>
