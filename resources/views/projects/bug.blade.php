...
@section('action-btn')
    <div class="float-end">
        @can('manage bug report')
            <a href="{{ route('task.bug.kanban',$project->id) }}"  data-bs-title="{{__('Kanban')}}" class="btn btn-sm btn-primary">
                                    ...
                                    <td class="Action" width="10%">
                                        @can('edit bug report')
                                            <div class="action-btn bg-info ms-2">
                                                <a href="#" data-size="lg" class="mx-3 btn btn-sm  align-items-center" data-url="{{ route('task.bug.edit',[$project->id,$bug->id]) }}" data-ajax-popup="true" data-size="xl"  data-bs-title="{{__('Edit')}}" data-bs-toggle="{{__('Edit Bug')}}">
