                            ...
                            @foreach($milestone->tasks as $task)
                                <tr>
                                    ...
                                    <td class="text-end w-15">
                                        <div class="actions">
                                            <a class="action-item px-2"  data-bs-title="{{__('Attachment')}}">
                                                <i class="ti ti-paperclip mr-2"></i>{{ count($task->taskFiles) }}
                                            </a>
                                            <a class="action-item px-2"  data-bs-title="{{__('Comment')}}">
                                                <i class="ti ti-brand-hipchat mr-2"></i>{{ count($task->comments) }}
                                            </a>
                                            <a class="action-item px-2"  data-bs-title="{{__('Checklist')}}">
