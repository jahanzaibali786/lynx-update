...
@section('action-btn')
    <div class="float-end">
        <a href="#" data-size="md" data-url="{{ route('clientuser.create') }}" data-ajax-popup="true"   data-bs-title="{{__('Create')}}"  class="btn btn-sm btn-primary">
            Create
        </a>
    </div>
@endsection
...
{{--                                            <a href="{{ route('clients.show',$client->id) }}"  class="dropdown-item" data-bs-title="{{__('View')}}">--}}
{{--                                                <i class="ti ti-eye"></i>--}}
{{--                                                <span>{{__('Show')}}</span>--}}
{{--                                            </a>--}}

                                            @can('edit clientuser')
                                                <a href="#!" data-size="md" data-url="{{ route('clientuser.edit',$client->id) }}" data-ajax-popup="true" class="dropdown-item" data-bs-title="{{__('Edit User')}}">
                                            ...
                                            @can('delete client')
                                                {!! Form::open(['method' => 'DELETE', 'route' => ['clientuser.destroy', $client['id']],'id'=>'delete-form-'.$client['id']]) !!}
                                            ...
                                            {{-- <a href="#!" data-url="{{route('clients.reset',\Crypt::encrypt($client->id))}}" data-ajax-popup="true" class="dropdown-item" data-bs-title="{{__('Reset Password')}}">
