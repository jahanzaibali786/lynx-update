...
{{--                                        @endif--}}
                                        @if (!empty($application->resume))
                                            <span class="action-btn bg-primary ms-2">
                                                <a class="mx-3 btn btn-sm align-items-center"  href="{{$resumes. '/' . $application->resume }}"  
                                    ...
                                    <td>
                                        @can('show job application')
                                            <div class="action-btn bg-info ms-2">
                                                ...
                                                <a class="mx-3 btn btn-sm  align-items-center"  data-bs-title="{{__('View')}}" data-bs-toggle="{{__('Details')}}" href="{{ route('job-application.show',\Crypt::encrypt($application->id)) }}"> <i class="ti ti-eye text-white"></i></a>
                                            </div>
                                        @endcan
                                    </td>
                                </tr>
