...
@section('action-btn')
    <div class="float-end">
        ...
        @can('create job application')
            <a href="#" data-size="lg" data-url="{{ route('job-application.create')}}" data-ajax-popup="true"  data-bs-title="{{__('Create')}}" data-bs-toggle="{{__('Create New Job Application')}}" class="btn btn-sm btn-primary">
                Create
            </a>
        @endcan
                    ...
                    <div class="card-body">
                        ...
                        <div class="row d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                ...
                                <a href="#" class="btn btn-sm btn-primary" onclick="document.getElementById('applicarion_filter').submit(); return false;"  data-bs-title="{{__('apply')}}">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <ul class="list-inline mb-0 mt-0">
                                                    ...
                                                    <li class="list-inline-item d-inline-flex align-items-center"  data-bs-title="{{__('Product')}}">
                                                        <i class="ti ti-clock me-1" data-ajax-popup="true" data-bs-toggle="{{__('Applied at')}}"></i>{{\Auth::user()->dateFormat($application->created_at)}}
