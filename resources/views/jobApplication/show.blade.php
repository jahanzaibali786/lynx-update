    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card job-create">
                            ...
                            <ul class="list-inline mb-0">
                                @can('delete job application')
                                    <li class="list-inline-item float-end">
                                        ...
                                        <a href="#" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" class="bs-pass-para"  data-confirm-yes="document.getElementById('archive-form-{{$jobApplication->id}}').submit();">
                                    ...
                                    @if($jobApplication->is_archive==0)
                                        <li class="list-inline-item">
                                            ...
                                            <a href="#" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" class="bs-pass-para"  data-confirm-yes="document.getElementById('delete-form-{{$jobApplication->id}}').submit();">
                ...
                <div class="card-body ">
                    <h5 class="h4">
                        <div class="d-flex align-items-center"  data-placement="right" data-bs-title="2 hrs ago" title="" title="">
                            <div>
                                @php
            ...
            <div class="card ">
                    ...
                    <div class="row">
                        ...
                        <div class="col text-end">
                            <div class="col-12 text-end">
                                <a href="#" data-url="{{route('job.on.board.create', $jobApplication->id)}}" data-bs-toggle="{{__('Add to Job OnBoard')}}" data-ajax-popup="true" class="btn-sm btn btn-primary">
                                    Create{{__('Add to Job OnBoard')}}</a>
                            </div>
                ...
                <div class="card-body">
                    ...
                    <div class='rating-stars text-right'>
                        <ul id='stars'>
                            <li class='star {{(in_array($jobApplication->rating,[1,2,3,4,5])==true)?'selected':''}}'    data-bs-title="Poor" data-value='1'>
                                <i class='fas fa-star fa-fw'></i>
                            </li>
                            <li class='star {{(in_array($jobApplication->rating,[2,3,4,5])==true)?'selected':''}}'    data-bs-title='Fair' data-value='2'>
                                <i class='fas fa-star fa-fw'></i>
                            </li>
                            <li class='star {{(in_array($jobApplication->rating,[3,4,5])==true)?'selected':''}}'    data-bs-title='Good' data-value='3'>
                                <i class='fas fa-star fa-fw'></i>
                            </li>
                            <li class='star {{(in_array($jobApplication->rating,[4,5])==true)?'selected':''}}'    data-bs-title='Excellent' data-value='4'>
                                <i class='fas fa-star fa-fw'></i>
                            </li>
                            <li class='star {{(in_array($jobApplication->rating,[5])==true)?'selected':''}}'    data-bs-title='WOW!!!' data-value='5'>
                                <i class='fas fa-star fa-fw'></i>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col text-end">
                    @can('create interview schedule')
                        <a href="#" data-url="{{ route('interview-schedule.create',$jobApplication->id) }}" data-size="lg" class="btn-sm btn btn-primary" data-ajax-popup="true" data-bs-toggle="{{__('Create New Interview Schedule')}}">
                            Create {{__('Create Interview Schedule')}}
                        </a>
                    @endcan
                </div>
            </div>
                            ...
                            @can('delete job application note')
                                @if($note->note_created==\Auth::user()->id)
                                    <div class="action-btn bg-danger ms-2">
                                        ...
                                        <a class="mx-3 btn btn-sm align-items-center bs-pass-para" href="#" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?"  data-bs-title="{{__('Delete')}}" data-confirm-yes="document.getElementById('delete-form-{{$note->id}}').submit();">
