...
@section('action-btn')
    <div class="float-end">
        <a href="{{ route('leads.index') }}"  data-bs-title="{{ __('Kanban View') }}"
            class="btn btn-sm btn-primary">
            <i class="ti ti-layout-grid"></i>
        </a>
        <a href="#" data-size="lg" data-url="{{ route('leads.create') }}" data-ajax-popup="true"
             data-bs-title="{{ __('Create New User') }}" class="btn btn-sm btn-primary">
            Create
        </a>
    </div>
@endsection
