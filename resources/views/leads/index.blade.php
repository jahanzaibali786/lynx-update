...
@section('action-btn')
    <div class="float-end">
        ...
        <a href="{{ route('leads.list') }}" data-size="lg"  data-bs-title="{{__('List View')}}" class="btn btn-sm btn-primary">
            <i class="ti ti-list"></i>
        </a>
        <a href="#" data-size="lg" data-url="{{ route('leads.create') }}" data-ajax-popup="true"  data-bs-title="{{__('Create New Lead')}}" data-bs-toggle="{{__('Create Lead')}}" class="btn btn-sm btn-primary">
            Create
        </a>
    </div>
@endsection
                                                ...
                                                @if(Auth::user()->type != 'client')
                                                    <div class="btn-group card-option">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            @can('edit lead')
                                                                <a href="#!" data-size="md" data-url="{{ URL::to('leads/'.$lead->id.'/labels') }}" data-ajax-popup="true" class="dropdown-item" data-bs-title="{{__('Labels')}}">
                                                                    <i class="ti ti-bookmark"></i>
                                                                    <span>{{__('Labels')}}</span>
                                                                </a>

                                                                <a href="#!" data-size="lg" data-url="{{ URL::to('leads/'.$lead->id.'/edit') }}" data-ajax-popup="true" class="dropdown-item" data-bs-title="{{__('Edit Lead')}}">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="user-group">
                                                    @foreach($lead->users as $user)
                                                        <img src="@if($user->avatar) {{asset('/storage/uploads/avatar/'.$user->avatar)}} @else {{asset('storage/uploads/avatar/avatar.png')}} @endif" alt="image"  data-bs-title="{{$user->name}}">
                                                    @endforeach
                                                </div>
                                            </div>
                                        </div>
