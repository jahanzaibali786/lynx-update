...
@section('content')
    <div class="row">
        {{ Form::open(['url' => 'studypack', 'class' => 'w-100', 'id' => 'studypack-form']) }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                {{ Form::select('class', $class, isset($_GET['class']) ? $_GET['class'] : '', ['class' => 'form-control', 'id' => 'class', 'required' => 'required']) }}
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="form-group">
        ...
        <div class="col-12">
            <div class="card" style="padding-bottom:100px!important;">
                ...
                <div id="items-table-wrap" class="card-body table-border-style pt-0">
                    <table class="table table-sm mb-0" id="items-table" style="height: 100% !important;">
                        <thead>
                            <tr>
        ...
        <div class="modal-footer">
            <input type="button" value="{{ __('Cancel') }}" onclick="location.href = '{{ route('studypack.index') }}';" class="btn btn-light">
