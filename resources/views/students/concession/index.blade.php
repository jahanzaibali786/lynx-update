                ...
                @endphp
                    <tr data-id="{{ $concession->id }}">
                        ...
                        @php
                            ...
                            // Branch may send for approval / edit only while the
                            // concession is still a Draft or has been rolled back
                            // (case-insensitive, so 'draft'/'Draft' both match).
                            $isEditable = in_array(strtolower((string) $concession->status), ['draft', 'rollbacked']);
                        @endphp
                                ...
                                @if(!$isAdmin)
                                    @if($isEditable)
                                        <a href="{{ route('concession.change_status', [$concession->id, 'For Approval']) }}"
                                           class="btn mx-1 btn-sm btn-warning text-white"
                                           title="Send For Approval">
                                            <i class="ti ti-send"></i> Send For Approval
                                        </a>
                                        ...
                                        <a href="#"
                                           ...
                                           data-size="xl"
                                           style="background-color: #100773 !important;"
                                           class="btn mx-1 btn-sm btn-primary text-white"
                                           title="Edit">
                                             Edit
                                        </a>
                                    @endif
