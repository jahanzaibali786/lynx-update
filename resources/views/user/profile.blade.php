                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    <div class="choose-files d-flex">
                                        ...
                                        <div id="file_name" style="background: none !important;">
                                ...
                                <script>
                                    document.getElementById('avatar').addEventListener('change', function(event) {
                                        ...
                                        if (input.files && input.files.length > 0) {
                                            // Update the text of the filename display element with the selected file's name
