                    ...
                    @foreach($plans as $plan)
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <a href="{{route('plan.active',[$user->id,$plan->id])}}" class="btn btn-sm btn-warning my-auto" data-bs-title="{{__('Click to Upgrade Plan')}}"><i class="ti ti-shopping-cart-plus"></i></a>
                                @endif
                            </td>
                        </tr>
                    @endforeach
