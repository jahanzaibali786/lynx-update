                    ...
                    <div class="card-body">
                        ...
                        <div class="row align-items-center justify-content-end">
                            ...
                            <div class="col-auto mt-4">
                                <div class="row">
                                    <div class="col-auto">
                                        <a href="#" class="btn btn-sm btn-primary" onclick="document.getElementById('user_userlog').submit(); return false;"  data-bs-title="{{__('Apply')}}" data-bs-title="{{__('apply')}}">
                                            <span class="btn-inner--icon">Search</span>
                                        </a>
                                        <a href="{{route('user.userlog')}}" class="btn btn-sm btn-danger "   data-bs-title="{{ __('Reset') }}" data-bs-title="{{__('Reset')}}">
                                        ...
                                        <td>
                                            <div class="action-btn bg-warning ms-2">
                                                <a href="#" class="mx-3 btn btn-sm align-items-center" data-size="lg" data-url="{{ route('user.userlogview', [$user->id]) }}"
                                                   data-ajax-popup="true" data-size="md"  title="" data-bs-toggle="{{ __('View User Logs') }}" data-bs-title="{{ __('View') }}">
                                            ...
                                            @can('delete user')
                                                <div class="action-btn bg-danger ms-2">
                                                    ...
                                                    <a href="#" class="mx-3 btn btn-sm  align-items-center bs-pass-para"  title="" title="Delete" aria-label="Delete">
