...
@section('content')
    ...
    {{ Form::model($journalEntry, array('route' => array('cash-recipt-voucher.update', $journalEntry->id), 'method' => 'PUT','class'=>'w-100')) }}
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                        ...
                        <div class="form-icon-user">
                            <input type="text" class="form-control" value="{{\Auth::user()->CRVNumberFormat($journalEntry->journal_id)}}" readonly>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
...
{{--                                </td>--}}
    ...
    <div class="modal-footer">
        <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{route("cash-recipt-voucher.index")}}';" class="btn btn-light">
