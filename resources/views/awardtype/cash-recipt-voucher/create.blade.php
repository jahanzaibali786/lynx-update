...
@section('content')
    ...
    {{ Form::open(array('url' => 'cash-recipt-voucher','class'=>'w-100')) }}
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{\Auth::user()->CRVNumberFormat($journalId)}}" readonly>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
