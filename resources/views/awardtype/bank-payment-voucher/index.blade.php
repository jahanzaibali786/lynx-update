...
@section('action-btn')
    <div class="float-end">
        @can('create journal entry')
            <a href="{{ route('bank-payment-voucher.create') }}" data-bs-toggle="{{__('Create New Bank Payment Voucher')}}"   data-bs-title="{{__('Create')}}" class="btn mx-1 btn-sm btn-outline-primary">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        {{ Form::open(['route' => ['bank-payment-voucher.index'], 'method' => 'GET', 'id' => 'bank-payment-voucher_submit']) }}
                        <div class="row d-flex justify-content-end ">
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                <a href="#" class="btn mx-1 btn-sm btn-outline-primary"
                                    onclick="document.getElementById('bank-payment-voucher_submit').submit(); return false;"
                                     data-bs-title="{{ __('apply') }}">
                                    <span class="btn-inner--icon">Search</span>
                                </a>
                                <a href="{{ route('bank-payment-voucher.index') }}" class="btn mx-1 btn-sm btn-outline-danger" 
    ...
    @endif
                        ...
                        <table class="">
                            ...
                            @foreach ($journalEntries as $journalEntry)
                                <tr>
                                    <td class="Id">
                                        <a href="{{ route('bank-payment-voucher.show',$journalEntry->id) }}" class="btn btn-outline-primary">{{ AUth::user()->BPVNumberFormat($journalEntry->journal_id) }}</a>
                                    </td>
                                    ...
                                    <div class="action-btn  ms-2">
                                        @can('edit journal entry')
                                                ...
                                                <a data-bs-toggle="{{__('Edit Bank Payment Voucher')}}" href="{{ route('bank-payment-voucher.edit',[$journalEntry->id]) }}" class="mx-1 btn mx-1 btn-sm btn-outline-primary align-items-center"  data-bs-title="{{__('Edit')}}" data-bs-title="{{__('Edit')}}">
                                        ...
                                        @can('delete journal entry')
                                                    ...
                                                    {!! Form::open(['method' => 'DELETE', 'route' => array('bank-payment-voucher.destroy', $journalEntry->id),'id'=>'delete-form-'.$journalEntry->id]) !!}
