...
@section('page-title')
    {{__('Bank Payment Voucher Create')}}
@endsection
...
@section('content')
    ...
    {{ Form::open(array('url' => 'bank-payment-voucher','class'=>'w-100')) }}
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{\Auth::user()->BPVNumberFormat($journalId)}}" readonly>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
