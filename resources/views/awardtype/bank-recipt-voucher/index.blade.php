...
@section('action-btn')
    <div class="float-end">
        @can('create journal entry')
            <a href="{{ route('bank-recipt-voucher.create') }}" data-bs-toggle="{{__('Create New Bank Recipt Voucher')}}"   data-bs-title="{{__('Create')}}" class="btn mx-1 btn-sm btn-outline-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row d-flex justify-content-end ">
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                ...
                                <a href="{{ route('bank-recipt-voucher.index') }}" class="btn mx-1 btn-sm btn-outline-danger" 
    ...
    @endif
                        ...
                        <table class="">
                            ...
                            @foreach ($journalEntries as $journalEntry)
                                <tr>
                                    <td>{{ ($journalEntries->currentPage() - 1) * $journalEntries->perPage() + $loop->iteration }}</td>
                                    <td class="Id">
                                        <a href="{{ route('bank-recipt-voucher.show',$journalEntry->id) }}" class="btn btn-outline-primary">{{ AUth::user()->BRVNumberFormat($journalEntry->journal_id) }}</a>
                                    </td>
                                    ...
                                    <div class="action-btn  ms-2">
                                        @can('edit journal entry')
                                                ...
                                                <a data-bs-toggle="{{__('Edit Bank Recipt Voucher')}}" href="{{ route('bank-recipt-voucher.edit',[$journalEntry->id]) }}" class="mx-1 btn mx-1 btn-sm btn-outline-primary align-items-center"  data-bs-title="{{__('Edit')}}" data-bs-title="{{__('Edit')}}">
                                        ...
                                        @can('delete journal entry')
                                                    ...
                                                    {!! Form::open(['method' => 'DELETE', 'route' => array('bank-recipt-voucher.destroy', $journalEntry->id),'id'=>'delete-form-'.$journalEntry->id]) !!}
