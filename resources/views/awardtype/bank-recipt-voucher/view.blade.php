...
@section('page-title')
    {{__('Bank Recipt Voucher Detail')}}
@endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item">{{__('Vouchers')}}</li>
    <li class="breadcrumb-item"><a href="{{route('bank-recipt-voucher.index')}}">{{__('Bank Recipt Voucher Entry')}}</a></li>
    <li class="breadcrumb-item">{{ Auth::user()->BRVNumberFormat($journalEntry->journal_id) }}</li>
@endsection
                        ...
                        <div class="invoice-print">
                            <div class="row invoice-title mt-2">
                                <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12">
                                    <h2>{{__('Bank Recipt Voucher')}}</h2>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 text-end">
                                    <h3 class="invoice-number">{{ \AUth::user()->BRVNumberFormat($journalEntry->journal_id) }}</h3>
                                </div>
                                <div class="col-12">
                                    <hr>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-end">
                                    <small>
                                        ...
                                        {{\Auth::user()->BRVNumberFormat($journalEntry->journal_id)}}
                                    </small><br>
                                    <small>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <div class="font-weight-bold">{{__('Bank Recipt Voucher Account Summary')}}</div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="action-btn  ms-2">
                                                            {!! Form::open(['method' => 'DELETE', 'route' => array('brv.destroy', $account->id),'id'=>'delete-form-'.$account->id]) !!}
                                                            ...
                                                            <a href="#" class="mx-3 btn mx-1 btn-sm btn-outline-danger align-items-center bs-pass-para"  data-bs-title="{{__('Delete')}}" data-bs-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$account->id}}').submit();">
                                                               <span class="btn-inner--icon"> <i class="ti ti-trash text-white"></i></span>
                                                            </a>
                                                            {!! Form::close() !!}
