    ...
    <div class="card">
        <div class="card-body">
            <div class="row mb-4 align-items-center">
                ...
                <div class="col-6 ">
                    <div class="float-end">
                        <a data-bs-toggle="collapse" href="#form-checklist" role="button" aria-expanded="false" aria-controls="form-checklist"  data-bs-title="{{__('Add item')}}" class="btn btn-sm btn-primary">
                            Create
                        </a>
                    </div>
                </div>
                    ...
                    <div class="card border shadow-none">
                        <div class="px-3 py-2 row align-items-center">
                            ...
                            <div class="col-2 card-meta d-inline-flex align-items-center">
                                <button class="btn btn-sm btn-primary" type="button" id="checklist_submit"  data-bs-title="{{__('Create')}}">
                            ...
                            <div class="col-auto">
                                <div class="action-btn bg-danger ms-2">
                                    <a href="#" class="mx-3 btn btn-sm  align-items-center delete-checklist" data-url="{{ route('checklist.destroy',[$task->project_id,$checklist->id]) }}">
                                        <i  data-bs-title="{{__('Delete')}}" class="ti ti-trash text-white"></i>
                                    </a>
                                </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="row mb-4 align-items-center">
                ...
                <div class="col-6 ">
                    <div class="float-end">
                        <a data-bs-toggle="collapse" href="#add_file" role="button" aria-expanded="false" aria-controls="add_file"  data-bs-title="{{__('Add attachment')}}" class="btn btn-sm btn-primary">
                            Create
                        </a>
                    </div>
                </div>
                        ...
                        <div class="px-3 py-2 row align-items-center">
                            ...
                            <div class="col-2 card-meta d-inline-flex align-items-center">
                                <button class="btn btn-sm btn-primary" type="button" id="file_attachment_submit"
                                        data-action="{{ route('comment.store.file',[$task->project_id,$task->id]) }}"  data-bs-title="{{__('Create')}}">
                                    <i class="ti ti-check"></i>
                                </button>
                            </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <a href="#" class="avatar avatar-sm ms-2">
                                    <img  data-bs-title="{{(!empty($user)?$user->name:'')}}" @if($user->avatar) src="{{asset('/storage/uploads/avatar/'.$user->avatar)}}" @else src="{{asset('/storage/uploads/avatar/avatar.png')}}" @endif data-bs-title="{{ $user->name }}" class="wid-40 rounded-circle ml-3">
                                </a>
                            </div>
                            <div class="col ml-n2">
                        ...
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <a href="#" class="avatar avatar-sm rounded-circle ms-2">
                                    <img data-bs-title="{{(!empty($user)?$user->name:'')}}" @if($user->avatar) src="{{asset('/storage/uploads/avatar/'.$user->avatar)}}" @else src="{{asset('/storage/uploads/avatar/avatar.png')}}" @endif data-bs-title="{{ $comment->user->name }}" class="wid-40 rounded-circle ml-3">
                                </a>
                            </div>
                            <div class="col ml-n2">
        ...
        <div class="card-footer">
            ...
            <div class="col-12 d-flex">
                <div class="avatar me-3">
                    <img data-bs-title="{{(!empty(\Auth::user()) ? \Auth::user()->name:'')}}" @if(\Auth::user()->avatar) src="{{asset('/storage/uploads/avatar/'.\Auth::user()->avatar)}}" @else src="{{asset('/storage/uploads/avatar/avatar.png')}}" @endif data-bs-title="{{ Auth::user()->name }}" class="wid-40 rounded-circle ml-3">
                </div>
