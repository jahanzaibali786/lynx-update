...
@section('page-title')
    {{__('Cash Payment Voucher Detail')}}
@endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item">{{__('Vouchers')}}</li>
    <li class="breadcrumb-item"><a href="{{route('cash-payment-voucher.index')}}">{{__('Cash Payment Voucher Entry')}}</a></li>
    <li class="breadcrumb-item">{{ Auth::user()->CPVNumberFormat($journalEntry->journal_id) }}</li>
@endsection
@push('script-page')
                        ...
                        <div class="invoice-print">
                            <div class="row invoice-title mt-2">
                                <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12">
                                    <h2>{{__('Cash Payment Voucher')}}</h2>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 text-end">
                                    <h3 class="invoice-number">{{ \AUth::user()->CPVNumberFormat($journalEntry->journal_id) }}</h3>
                                </div>
                                <div class="col-12">
                                    <hr>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-end">
                                    <small>
                                        ...
                                        {{\Auth::user()->CPVNumberFormat($journalEntry->journal_id)}}
                                    </small><br>
                                    <small>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <div class="font-weight-bold">{{__('Cash Payment Voucher Account Summary')}}</div>
                                                ...
                                                <tr>
                                                    ...
                                                    {{-- <td>
                                                        <div class="action-btn bg-danger ms-2">
                                                            {!! Form::open(['method' => 'DELETE', 'route' => array('cpv.destroy', $account->id),'id'=>'delete-form-'.$account->id]) !!}

                                                            <a href="#" class="mx-3 btn btn-sm align-items-center bs-pass-para"  title="{{__('Delete')}}" data-original-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$account->id}}').submit();">
