...
@section('page-title')
    {{__('Cash Payment Voucher Create')}}
@endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Cash Payment Voucher')}}</li>
@endsection
...
@section('content')
    ...
    {{ Form::open(array('url' => 'cash-payment-voucher','class'=>'w-100','id'=>'journal-form')) }}
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{\Auth::user()->CPVNumberFormat($journalId)}}" readonly>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
    ...
    <div class="modal-footer">
        <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{route("cash-payment-voucher.index")}}';" class="btn btn-light">
         <span class="btn-inner--icon"> <input type="submit" value="{{__('Create')}}" class="btn btn-outline-primary"> </span>
    </div>
    {{ Form::close() }}
