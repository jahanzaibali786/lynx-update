            ...
            <table class="table modal-table">
                ...
                @if(!empty( $invoiceBankTransfer->receipt))
                    <tr>
                        ...
                        <td>
                            <a  class="action-btn bg-primary ms-2 btn btn-sm align-items-center" href="{{ $path . '/' . $invoiceBankTransfer->receipt }}" download=""   data-bs-title="{{__('Download')}}" target="_blank">
