        ...
        @if($invoice->status!=4)
            <div class="row">
                <div class="col-1 mb-4 d-flex justify-content-center align-items-center" style="background-color: white; border-radius: 10px">
                    ...
                    <a href="{{ route('invoice_back',\Crypt::encrypt($invoice->id)) }}" class="text-primary"  data-bs-title="{{__('Back')}}"><svg class="text-primary" fill="#000000" width="40px" height="200px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m19.2 2.43-2.422-2.43-11.978 12 11.978 12 2.422-2.43-9.547-9.57z"  fill="#100773"/></svg></a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row timeline-wrapper">
                            <div class="col-md-6 col-lg-4 col-xl-4" style="height: 150px">
                                ...
                                {{-- @can('edit invoice')
                                    <a href="{{ route('invoice.edit',\Crypt::encrypt($invoice->id)) }}" class="btn btn-sm btn-primary"  data-bs-title="{{__('Edit')}}"><i class="ti ti-pencil mr-2"></i>{{__('Edit')}}</a>
                                @endcan --}}
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-4" style="height: 150px">
                                <div class="timeline-icons"><span class="timeline-dots"></span>
                                ...
                                @if($invoice->status==0)
                                    @can('send bill')
                                        <a href="{{ route('invoice.sent',$invoice->id) }}" class="btn btn-sm btn-warning"  data-bs-title="{{__('Mark Sent')}}"><i class="ti ti-send mr-2"></i>{{__('Send')}}</a>
                                    @endcan
                                @endif
                            </div>
                            <div class="col-md-6 col-lg-4 col-xl-4" style="height: 150px">
                                ...
                                @if($invoice->status!=0)
                                    @can('create payment invoice')
                                        <a href="#" data-url="{{ route('invoice.payment',$invoice->id) }}" data-ajax-popup="true" data-bs-toggle="{{__('Add Payment')}}" class="btn btn-sm btn-info" data-bs-title="{{__('Add Payment')}}"><i class="ti ti-report-money mr-2"></i>{{__('Receive Payment')}}</a> <br>
                                    @endcan
                                @endif
                ...
                <div class="col-1 mb-4 d-flex justify-content-center align-items-center" style="background-color: white; border-radius: 10px">
                    <a href="{{ route('invoice_next',\Crypt::encrypt($invoice->id)) }}"  data-bs-title="{{__('Next')}}"><svg fill="#000000" width="40px" height="200px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m4.8 21.57 2.422 2.43 11.978-12-11.978-12-2.422 2.43 9.547 9.57z"  fill="#100773"/></svg></a>
                </div>
            </div>
        @endif
    @endcan
                                        ...
                                        @can('delete invoice product')
                                            <td>
                                                <div class="action-btn bg-danger ms-2">
                                                    ...
                                                    <a href="#" class="mx-3 btn btn-sm align-items-center bs-pass-para"  title="Delete" data-bs-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$payment->id}}').submit();">
                                        ...
                                        @can('delete invoice product')
                                            ...
                                            <td>
                                                @if($bankPayment->status == 'Pending')
                                                    <div class="action-btn bg-warning">
                                                        <a href="#" data-url="{{ URL::to('invoice/'.$bankPayment->id.'/action') }}" data-size="lg"
                                                           data-ajax-popup="true" data-bs-toggle="{{__('Payment Status')}}" class="mx-3 btn btn-sm align-items-center"
                                                            data-bs-title="{{__('Payment Status')}}" data-bs-title="{{__('Payment Status')}}">
                                                ...
                                                <div class="action-btn bg-danger ms-2">
                                                    ...
                                                    <a href="#" class="mx-3 btn btn-sm align-items-center bs-pass-para"  title="Delete" data-bs-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$bankPayment->id}}').submit();">
                                                        <i class="ti ti-trash text-white"></i>
                                                    </a>
                                                {!! Form::close() !!}
                                            </td>
                                    ...
                                    <td>
                                        @can('edit credit note')
                                            <div class="action-btn bg-primary ms-2">
                                                <a data-url="{{ route('invoice.edit.credit.note',[$creditNote->invoice,$creditNote->id]) }}" data-ajax-popup="true" data-bs-title="{{__('Edit')}}" data-bs-title="{{__('Credit Note')}}" href="#" class="mx-3 btn btn-sm align-items-center"  data-bs-title="{{__('Edit')}}">
                                        ...
                                        @can('delete credit note')
                                            <div class="action-btn bg-danger ms-2">
                                                ...
                                                <a href="#" class="mx-3 btn btn-sm align-items-center bs-pass-para "  title="Delete" data-bs-title="{{__('Delete')}}" data-confirm="{{__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')}}" data-confirm-yes="document.getElementById('delete-form-{{$creditNote->id}}').submit();">
                                                    <i class="ti ti-trash text-white"></i>
                                                </a>
                                                {!! Form::close() !!}
                                            </div>
