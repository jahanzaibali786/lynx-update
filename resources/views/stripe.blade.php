                                        ...
                                        @if($plan->id != 1 && $plan->id != \Auth::user()->plan)
                                            @if(\Auth::user()->requested_plan != $plan->id)
                                                <a href="{{ route('send.request',[\Illuminate\Support\Facades\Crypt::encrypt($plan->id)])}}"
                                                   class="btn btn-primary mb-2 me-3" data-bs-toggle="{{__('Send Request')}}"  data-bs-title="{{__('Send Request')}}">
                                                    <span class="btn-inner--icon">{{__('Send Request')}}</span>
                                                </a>
                                            @else
                                                <a href="{{ route('request.cancel',\Auth::user()->id) }}" class="btn btn-danger mb-2 me-3"
                                                   data-bs-toggle="{{__('Cancle Request')}}"  data-bs-title="{{__('Cancle Request')}}">
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="form-group ms-3 mt-4">
                                                        <a href="#" class="text-muted "  data-bs-title="{{ __('Apply') }}"><i class="ti ti-square-check btn-apply apply-coupon"></i>
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mt-4">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="form-group ms-3 mt-4">
                                                            <a class="text-muted "  data-bs-title="{{ __('Apply') }}"><i class="ti ti-square-check btn-apply apply-coupon"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mt-4">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="form-group ms-3 mt-4">
                                                            <a  class="text-muted "  data-bs-title="{{ __('Apply') }}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mt-4">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="form-group ms-3 mt-4">
                                                            <a class="text-muted apply-coupon"  data-bs-title="{{ __('Apply') }}"><i class="ti ti-square-check btn-apply apply-coupon"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
