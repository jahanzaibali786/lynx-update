...
@section('action-btn')
    <div class="float-end">
        <a href="#" onclick="saveAsPDF();" class="btn btn-sm btn-primary dwn"  data-bs-title="{{__('Project Report Download')}}">
            Pdf / Print
        </a>
    </div>
@endsection
        ...
        <div class="row" id="printableArea">
                ...
                <div class="col-md-3">
                    <div class="card">
                        <div class="card-header">
                            <div class="float-end">
                                <a href="#"  data-bs-placement="top" title="Refferals"><i class=""></i></a>
                            </div>
                                        ...
                                        @foreach($tasks as $task)
                                            ...
                                            <td>
                                                <a href="#!" data-size="md" data-url="{{ route('projects.tasks.show',[$project->id,$task->id]) }}"
                                                   data-ajax-popup="true" class="dropdown-item" data-bs-title="{{__('View')}}">
                                                    {{$task->name}}
                                                </a>
                                            </td>
                                                            ...
                                                            @foreach($users as $key => $user)
                                                                @if($key<3)
                                                                    <a href="#" class="avatar rounded-circle avatar-sm">
                                                                        <img src="{{$user->getImgImageAttribute()}}" data-bs-title="{{ $user->name }}">
                                                                    </a>
                                                                @else
                                                                    @break
                                                                @endif
