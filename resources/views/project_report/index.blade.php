                                                ...
                                                @foreach($project->users as $key => $user)
                                                    @if($key < 3)
                                                        <a href="#" class="avatar rounded-circle">
                                                            ...
                                                            data-bs-title="{{ $user->name }}" style="height:36px;width:36px;">
                                                        </a>
                                                    @else
                                                        @break
                                                    @endif
                                    ...
                                    <td class="">
                                        @can('manage project')
                                            <div class="action-btn bg-warning ms-2">
                                                <a href="{{ route('project_report.show', $project->id) }}" class="mx-3 btn btn-sm align-items-center"  data-bs-title="{{__('View Project Report')}}" data-bs-title="{{__('Detail')}}">
