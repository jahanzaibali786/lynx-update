{{ Form::model($challan, array('route' => array('challan.paid', $challan->id), 'method' => 'POST')) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group  col-md-6">
            ...
            @endphp
            {{ Form::number('amount',$dueamount, array('class' => 'form-control','required'=>'required','step'=>'0.01')) }}
        </div>
        <div class="form-group  col-md-6">
