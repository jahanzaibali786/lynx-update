    ...
    <div class="content" id="report-content">
        <div class="card mt-2 p-4">
            ...
            <table class="datatable maximumHeightNew">
                ...
                @php $totalTransferFee = 0; @endphp
                @php $previousBranchName = ''; @endphp
                @foreach ($studenttransfer as $transfer)
                    ...
                    @php $previousBranchName = $transfer->branchfrom->name; @endphp
                @endforeach
                <tr class="total-row trNew" style="background-color: #808080; ">
                    <td colspan="13" class="total-cell-right" style=" background-color: #808080; font-size: 10px; font-weight: bold; text-align: right; padding-right: 10px;">TOTAL</td>
                    <td class="total-cell-center" style="background-color: #808080;  font-size: 8px; text-align: left; font-weight: bold;">{{ number_format($totalTransferFee, 0) }}</td>
