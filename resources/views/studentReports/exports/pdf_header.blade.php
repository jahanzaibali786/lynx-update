...
<div style="width: 100%; position: relative; bottom: 40px; display: table; position:relative;">
    <span style="font-weight:bold;">From</span>
    <span style="display:inline-block; border-bottom:1px solid #000; min-width:120px; margin:0 8px 0 4px; vertical-align:middle;">
      {{ date('d M Y', strtotime($request->input('date_from') ? $request->input('date_from') : now()->startOfYear())) }}
    </span>
    <span style="font-weight:bold;">To</span>
    <span style="display:inline-block; border-bottom:1px solid #000; min-width:120px; margin-left:4px; vertical-align:middle;">
      {{ date('d M Y', strtotime($request->input('date_to') ? $request->input('date_to') : now())) }}
    </span>
  </div>
