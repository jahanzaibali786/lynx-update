                            ...
                            <div class="row">
                                ...
                                @can('create set salary')
                                    <div class="col text-end">
                                        <a href="#" data-url="{{ route('employee.basic.salary',$employee->id) }}" data-size="md" data-ajax-popup="true" data-bs-toggle="{{__('Set Basic Sallary')}}"  data-bs-title="{{__('Basic Salary')}}" class="btn btn-sm btn-primary">
                                            Create
                                        </a>
                                    </div>
                                @endcan
                        ...
                        <div class="card-header ">
                            <div class="row">
                                ...
                                @can('create allowance')
                                    <div class="col text-end">
                                        <a href="#" data-url="{{ route('allowances.create',$employee->id) }}" data-size="md" data-ajax-popup="true" data-bs-toggle="{{__('Create Allowance')}}"   data-bs-title="{{__('Create')}}" data-bs-title="{{__('Create Allowance')}}" class="apply-btn btn btn-sm btn-primary">
                                            Create
                                        </a>
                                    </div>
                                @endcan
                                                    ...
                                                    <td class="">
                                                        @can('edit allowance')
                                                            <div class="action-btn bg-primary ms-2">
                                                                <a href="#" data-url="{{ URL::to('allowance/'.$allowance->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-bs-toggle="{{__('Edit Allowance')}}" class="mx-3 btn btn-sm align-items-center"   data-bs-title="{{__('Edit')}}" data-bs-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i></a>
                                                            </div>
                                                        @endcan
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                @can('create commission')
                                    <div class="col text-end">
                                        <a href="#" data-url="{{ route('commissions.create',$employee->id) }}" data-size="md" data-ajax-popup="true" data-bs-toggle="{{__('Create Commission')}}"  data-bs-title="{{__('Create')}}" data-bs-title="{{__('Create Commission')}}" class="apply-btn btn btn-sm btn-primary">
                                            Create
                                        </a>
                                    </div>
                                @endcan
...
{{--                                                    @dd($commission)--}}
                                                ...
                                                <td class="">
                                                    @can('edit commission')
                                                        <div class="action-btn bg-primary ms-2">
                                                            <a href="#" data-url="{{ URL::to('commission/'.$commission->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-bs-toggle="{{__('Edit Commission')}}" class="mx-3 btn btn-sm align-items-center"   data-bs-title="{{__('Edit')}}" data-bs-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i></a>
                                                        </div>
                                                    @endcan
                    ...
                    <div class="card min-height-253">
                        <div class="card-header">
                            <div class="row">
                                ...
                                @can('create loan')
                                    <div class="col text-end">
                                        <a href="#" data-url="{{ route('loans.create',$employee->id) }}" data-size="lg" data-ajax-popup="true" data-bs-toggle="{{__('Create Loan')}}"   data-bs-title="{{__('Create')}}" data-bs-title="{{__('Create Loan')}}" class="apply-btn btn btn-sm btn-primary">
                                            Create
                                        </a>
                                    </div>
                                @endcan
...
{{--                                                <td>{{ \Auth::user()->dateFormat( $loan->end_date) }}</td>--}}
                                                ...
                                                <td class="">
                                                    @can('edit loan')
                                                        <div class="action-btn bg-primary ms-2">
                                                            <a href="#" data-url="{{ URL::to('loan/'.$loan->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-bs-toggle="{{__('Edit Loan')}}" class="mx-3 btn btn-sm align-items-center" data-bs-title="{{__('Edit')}}"  data-bs-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i></a>
                                                        </div>
                                                    @endcan
                                                    @can('delete loan')
                                                        <div class="action-btn bg-danger ms-2">
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                @can('create saturation deduction')
                                    <div class="col text-end">
                                        <a href="#" data-url="{{ route('saturationdeductions.create',$employee->id) }}" data-size="lg" data-ajax-popup="true" data-bs-toggle="{{__('Create Saturation Deduction')}}"  data-bs-title="{{__('Create')}}" data-bs-title="{{__('Create Saturation Deduction')}}" class="apply-btn btn btn-sm btn-primary">
                                            Create
                                        </a>
                                    </div>
                                @endcan
                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                    @can('edit saturation deduction')
                                                        <div class="action-btn bg-primary ms-2">
                                                            <a href="#" data-url="{{ URL::to('saturationdeduction/'.$saturationdeduction->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-bs-toggle="{{__('Edit Saturation Deduction')}}" class="mx-3 btn btn-sm align-items-center"  data-bs-title="{{__('Edit')}}" data-bs-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i></a>
                                                        </div>
                                                    @endcan
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                @can('create other payment')
                                    <div class="col text-end">
                                        <a href="#" data-url="{{ route('otherpayments.create',$employee->id) }}" data-size="lg" data-ajax-popup="true" data-bs-toggle="{{__('Create Other Payment')}}"  data-bs-title="{{__('Create')}}" data-bs-title="{{__('Create Other Payment')}}" class="apply-btn btn btn-sm btn-primary">
                                            Create
                                        </a>
                                    </div>
                                @endcan
                                            ...
                                            <tr>
                                                ...
                                                <td class="">
                                                    @can('edit other payment')
                                                        <div class="action-btn bg-primary ms-2">
                                                            <a href="#" data-url="{{ URL::to('otherpayment/'.$otherpayment->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-bs-title="{{__('Edit')}}" data-bs-toggle="{{__('Edit Other Payment')}}" class="mx-3 btn btn-sm  align-items-center"  data-bs-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i></a>
                                                        </div>
                                                    @endcan
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                @can('create overtime')
                                    <div class="col text-end">
                                        <a href="#" data-url="{{ route('overtimes.create',$employee->id) }}" data-size="md" data-ajax-popup="true" data-bs-toggle="{{__('Create Overtime')}}"  data-bs-title="{{__('Create Overtime')}}" class="apply-btn btn btn-sm btn-primary">
                                            Create
                                        </a>
                                    </div>
                                @endcan
                                                ...
                                                <td class="">
                                                    @can('edit overtime')
                                                        <div class="action-btn bg-primary ms-2">
                                                            ...
                                                            <a href="#" data-url="{{ URL::to('overtime/'.$overtime->id.'/edit') }}" data-size="lg" data-ajax-popup="true" data-bs-toggle="{{__('Edit OverTime')}}" class="mx-3 btn btn-sm align-items-center"  data-bs-title="{{__('Edit')}}" data-bs-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i></a>
                                                        </div>
                                                    @endcan
                                                    @can('delete overtime')
                                                        <div class="action-btn bg-danger ms-2">
