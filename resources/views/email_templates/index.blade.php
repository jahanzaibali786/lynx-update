...
{{--                   data-bs-toggle="{{__('Create New Email Template')}}" data-bs-title="{{__('Create')}}" data-url="{{route('email_template.create')}}">--}}
{{--                    Create </a>--}}
{{--    </div>--}}
                                    ...
                                    @if(\Auth::user()->type=='super admin')
                                        <div class="text-end">
                                            <div class="action-btn bg-warning ms-2">
                                                <a href="{{ route('manage.email.language',[$EmailTemplate->id,\Auth::user()->lang]) }}" class="mx-3 btn btn-sm d-inline-flex align-items-center"  data-bs-title="{{__('View')}}">
