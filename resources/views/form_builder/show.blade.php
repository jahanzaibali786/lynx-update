...
@section('action-btn')
    @can('create form field')
        <div class="float-end">
            <a href="#" data-size="md" data-url="{{ route('form.field.create',$formBuilder->id) }}" data-ajax-popup="true"  data-bs-title="{{__('Create New Filed')}}" class="btn btn-sm btn-primary">
                Create
            </a>
        </div>
    @endcan
                                        ...
                                        <td class="text-end">
                                            @can('edit form builder')
                                                <div class="action-btn bg-info ms-2">
                                                    <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-url="{{ route('form.field.edit',[$formBuilder->id,$field->id]) }}" data-ajax-popup="true" data-size="md"  data-bs-title="{{__('Edit')}}" data-bs-toggle="{{__('Form Builder Edit')}}">
