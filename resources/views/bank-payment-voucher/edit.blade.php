...
@section('content')
    ...
    {{ Form::model($journalEntry, array('route' => array('bank-payment-voucher.update', $journalEntry->id), 'method' => 'PUT','class'=>'w-100')) }}
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="form-group">
                        ...
                        <div class="form-icon-user">
                            <input type="text" class="form-control" value="{{\Auth::user()->BPVNumberFormat($journalEntry->journal_id)}}" readonly>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4">
                        ...
                        <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                            <div class="all-button-box">
                                <a href="#" data-repeater-create="" class="btn btn-outline-primary me-4" data-toggle="modal" data-target="#add-bank">
                                      <span class="btn-inner--icon"> Create {{__('Add Account')}} </span>
                                </a>
                            </div>
                        </div>
                    </div>
...
{{--                                </td>--}}
    ...
    <div class="modal-footer">
        <input type="button" value="{{__('Cancel')}}" onclick="location.href = '{{route("bank-payment-voucher.index")}}';" class="btn btn-light">
        <span class="btn-inner--icon"> <input type="submit" value="{{__('Update')}}" class="btn btn-outline-primary"> </span>
    </div>
    {{ Form::close() }}
