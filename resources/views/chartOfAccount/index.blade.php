...
<div class="float-end">
    ...
    <a href="#" data-url="{{ route('chart-of-account.create') }}"  data-bs-title="{{ __('Create') }}"
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    ...
                                    <a href="{{ route('chart-of-account.index') }}"
                                        ...
                                        data-bs-title="{{ __('Reset') }}" data-bs-title="{{ __('Reset') }}">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="badge bg-outline-primary p-2 px-3 rounded">{{ __('Enabled') }}</span>
                                    @else
                                    <span class="badge bg-outline-danger p-2 px-3 rounded">{{ __('Disabled') }}</span>
                                    @endif
                                </td>
                                <td class="">
                                    <div class="action-btn ms-2">
                                        ...
                                        <a href="#" class="mx-1 btn btn-sm align-items-center btn-outline-primary"
