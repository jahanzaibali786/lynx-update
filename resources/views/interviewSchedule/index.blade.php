...
@section('action-btn')
    <div class="float-end">
        @can('create interview schedule')
            <a href="#" data-url="{{ route('interview-schedule.create') }}"  data-bs-title="{{__('Create')}}" data-ajax-popup="true" data-bs-toggle="{{__('Create New Interview Schedule')}}" class="btn btn-sm btn-primary">
                Create
            </a>
        @endcan
    </div>
                                                        ...
                                                        <div class="col-auto text-right">
                                                            @can('edit interview schedule')
                                                                <div class="action-btn bg-primary ms-2">
                                                                    <a href="#" data-url="{{ route('interview-schedule.edit',$schedule->id) }}" data-bs-toggle="{{__('Edit Interview Schedule')}}" data-ajax-popup="true" class="mx-3 btn btn-sm  align-items-center"  data-bs-title="{{__('Edit')}}" data-bs-title="{{__('Edit')}}"><i class="ti ti-pencil text-white"></i></a>
                                                                </div>
                                                            @endcan
