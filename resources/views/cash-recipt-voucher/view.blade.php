...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{route('cash-recipt-voucher.index')}}">{{__('Cash Recipt Voucher Entry')}}</a></li>
                        ...
                        <div class="invoice-print">
                            <div class="row invoice-title mt-2">
                                <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12">
                                    <h2>{{__('Cash Recipt Voucher')}}</h2>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 text-end">
                                    <h3 class="invoice-number">{{ \AUth::user()->CRVNumberFormat($journalEntry->journal_id) }}</h3>
                                </div>
                                <div class="col-12">
                                    <hr>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-end">
                                    <small>
                                        ...
                                        {{\Auth::user()->CRVNumberFormat($journalEntry->journal_id)}}
                                    </small><br>
                                    <small>
                            ...
                            <div class="row mt-4">
                                <div class="col-md-12">
                                    <div class="font-weight-bold">{{__('Cash Recipt Voucher Account Summary')}}</div>
                                                ...
                                                <tr>
                                                    ...
                                                    {{-- <td>
                                                        <div class="action-btn bg-danger ms-2">
                                                            {!! Form::open(['method' => 'DELETE', 'route' => array('crv.destroy', $account->id),'id'=>'delete-form-'.$account->id]) !!}
