...
@section('action-btn')
    ...
    <div class="float-end">
        @can('create journal entry')
            <a href="{{ route('cash-recipt-voucher.create') }}" title="{{ __('Create New Cash Recipt Voucher') }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row d-flex justify-content-end ">
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                ...
                                <a href="{{ route('cash-recipt-voucher.index') }}"
        ...
        <tbody>
            @foreach ($journalEntries as $journalEntry)
                <tr>
                    ...
                    <td class="Id">
                        <a href="{{ route('cash-recipt-voucher.show', $journalEntry->id) }}"
                            class="btn btn-outline-primary"><span class="btn-inner--icon">{{ AUth::user()->CRVNumberFormat($journalEntry->journal_id) }}</span></a>
                    </td>
                    ...
                    <td>
                        <div class="action-btn ms-2">
                            ...
                            @can('edit journal entry')
                                <a title="{{ __('Edit Cash Recipt Voucher') }}"
                                    href="{{ route('cash-recipt-voucher.edit', [$journalEntry->id]) }}"
                        ...
                        @can('delete journal entry')
                            {!! Form::open([
                                'method' => 'DELETE',
                                'route' => ['cash-recipt-voucher.destroy', $journalEntry->id],
