...
@section('action-btn')
    <div class="float-end">
        <a href="#" data-size="md" data-url="{{ route('stages.create') }}" data-ajax-popup="true"  data-bs-title="{{__('Create Deal Stage')}}" class="btn btn-sm btn-primary">
            Create
        </a>
    </div>
@endsection
                                                ...
                                                @else
                                                    ...
                                                    <span class="float-end">
                                                        @can('edit lead stage')
                                                                ...
                                                                <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-url="{{ URL::to('stages/'.$stage->id.'/edit') }}" data-ajax-popup="true" data-size="md"  data-bs-title="{{__('Edit')}}" data-bs-toggle="{{__('Edit Lead Stages')}}">
