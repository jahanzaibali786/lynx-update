...
@section('action-btn')
    <div class="float-end">
        @can('create job stage')
            <a href="#" data-url="{{ route('job-stage.create') }}" data-ajax-popup="true" data-bs-toggle="{{__('Create New Job Stage')}}"  data-bs-title="{{__('Create')}}"  class="btn btn-sm btn-primary">
                Create
            </a>
                                        ...
                                        <span class="float-end">
                                            @can('edit job stage')
                                                <div class="action-btn bg-primary ms-2">
                                                    <a href="#" class="mx-3 btn btn-sm align-items-center" data-url="{{ route('job-stage.edit',$stage->id) }}" data-ajax-popup="true" data-bs-toggle="{{__('Edit Job Stage')}}"  data-bs-title="{{__('Edit')}}" data-bs-title="{{__('Edit')}}">
