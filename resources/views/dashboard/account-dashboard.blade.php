                                    ...
                                    <div class="card mb-5 hover-border-primary">
                                        ...
                                        <div
                                            ...
                                            <div class="account-dashboard-svg">
                                                ...
                                                <svg height="64px" width="74px" version="1.1" id="_x32_"
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                                                    viewBox="-302.08 -302.08 1116.16 1116.16" xml:space="preserve"
                                                    fill="#100773" stroke="#100773" stroke-width="0.00512">
                                            ...
                                            <div class="display-6 text-primary">{{ \Auth::user()->countStudents() }}</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card mb-5 hover-border-primary">
                                        ...
                                        <div
                                            ...
                                            <div class="account-dashboard-svg">
                                                ...
                                                <svg width="64px" height="64px" viewBox="-614.4 -614.4 2252.80 2252.80"
                                                    class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                    fill="#100773" stroke="#100773">
                                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                        stroke-linejoin="round"></g>
                                                    <g id="SVGRepo_iconCarrier">
                                            ...
                                            <div class="display-6 text-primary">{{ \Auth::user()->countEmployee() }}</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                    <div class="card mb-5 hover-border-primary">
                                        ...
                                        <div
                                            ...
                                            <div class="account-dashboard-svg">
                                                ...
                                                <svg fill="#100773" height="64px" width="64px" version="1.1"
                                                    id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                                                    viewBox="-282.88 -282.88 1007.76 1007.76" xml:space="preserve"
                                                    stroke="#100773" stroke-width="0.00442">
                                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                        stroke-linejoin="round"></g>
                                                    <g id="SVGRepo_iconCarrier">
                                            ...
                                            <div class="display-6 text-primary">{{ \Auth::user()->countChallans() }}</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-6">
                                        ...
                                        <div
                                            ...
                                            <div class="account-dashboard-svg">
                                                ...
                                                <svg fill="#100773" height="64px" width="64px" version="1.1"
                                                    id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                                                    viewBox="-265.19 -265.19 987.60 987.60" xml:space="preserve"
                                                    stroke="#100773">
                                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                        stroke-linejoin="round"></g>
                                            ...
                                            <div class="display-6 text-primary">{{ \Auth::user()->countVouchers() }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-5 hover-border-primary">
                                <div class="card-header">
                                    <h5>{{ __('Income & Expense') }}
                                        <span
                                            class="float-end  text-primary">{{ __('Current Year') . ' - ' . $currentYear }}</span>
                                    </h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-6 my-2">
                                            <div class="d-flex align-items-start mb-2">
                                                <div
                                                    class="sw-8 sh-8 rounded-xl d-flex justify-content-center align-items-center account-dashboard-svg ">

                                                    <svg fill="#100773" width="64px" height="64px"
                                                        viewBox="-747.52 -747.52 2519.04 2519.04"
                                                        xmlns="http://www.w3.org/2000/svg" stroke="#100773">
                                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                            stroke-linejoin="round"></g>
                                                        <g id="SVGRepo_iconCarrier">
                                            ...
                                            <div class="d-flex align-items-start mb-2">
                                                <div
                                                    ...
                                                    <svg width="64px" height="64px"
                                                        viewBox="-17.28 -17.28 58.56 58.56" id="Layer_1"
                                                        ...
                                                        <g id="SVGRepo_iconCarrier">
                                                            ...
                                                            <line class="cls-1" x1="18.68" y1="0.52"
                                                                x2="18.68" y2="2.43"></line>
                                                            <line class="cls-1" x1="18.68" y1="8.16"
                                                                x2="18.68" y2="10.07"></line>
                                                        </g>
                                                    </svg>
                                            ...
                                            <div class="d-flex align-items-start mb-2">
                                                <div
                                                    ...
                                                    <svg fill="#100773" height="64px" width="64px" version="1.1"
                                                        id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                                        xmlns:xlink="http://www.w3.org/1999/xlink"
                                                        viewBox="-248.73 -248.73 985.16 985.16" xml:space="preserve"
                                                        stroke="#100773">
                                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                            stroke-linejoin="round"></g>
                                        ...
                                        <div class="col-md-6 col-6 my-2">
                                            <div class="d-flex align-items-start mb-2">
                                                ...
                                                <div
                                                    ...
                                                    <svg width="64px" height="64px"
                                                        viewBox="-634.88 -634.88 2293.76 2293.76" fill="#100773"
                                                        class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                        stroke="#100773">
                                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round"
                                                ...
                                                <div class="ms-2">
                                                    <p class="text-primary text-sm mb-0">{{ __('Expense This Month') }}
                                                    </p>
                            ...
                            <div class="card hover-border-primary">
                                <div class="card-header">
                                    <h5>{{ __('Storage Limit') }}
                                        ...
                                        <small class="float-end text-primary">{{ $users->storage_limit . 'MB' }} /
