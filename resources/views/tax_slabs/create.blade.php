...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::select('year', $years, old('year', $currentYear), ['class' => 'form-control', 'required' => 'required']) }}
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::number('no', '', ['class' => 'form-control', 'required' => 'required']) }}
            @error('no')
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::number('lower_limit', '0', ['class' => 'form-control', 'required' => 'required']) }}
            @error('lower_limit')
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::number('upper_limit', '0', ['class' => 'form-control', 'required' => 'required']) }}
            @error('upper_limit')
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::number('fixed_tax_amount', '0', ['class' => 'form-control', 'required' => 'required']) }}
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::number('prev_limit_percentage', '0', ['class' => 'form-control', 'required' => 'required']) }}
