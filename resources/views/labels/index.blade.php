...
@section('action-btn')
    @can('create label')
        <div class="float-end">
            <a href="#" data-size="md" data-url="{{ route('labels.create') }}" data-ajax-popup="true"  data-bs-title="{{__('Create Labels')}}" class="btn btn-sm btn-primary">
                Create
            </a>
        </div>
    @endcan
                                        ...
                                        @foreach ($pipeline['labels'] as $label)
                                            <li class="list-group-item" data-id="{{$label->id}}">
                                                ...
                                                @can('edit label')
                                                        ...
                                                        <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-url="{{ URL::to('labels/'.$label->id.'/edit') }}" data-ajax-popup="true" data-size="md"  data-bs-title="{{__('Edit')}}" data-bs-toggle="{{__('Edit Labels')}}">
