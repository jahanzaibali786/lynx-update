    ...
    <div class="modal-content">
            ...
            <div class="col-auto">
                <div class="actions text-end">
                    <div class="float-left">
                        <a href="#" class="action-item {{($task->is_favourite) ? 'action-favorite' : ''}} active" data-url="{{ route('change.fav',[$task->project_id,$task->id]) }}" id="add_favourite"  data-bs-title="{{__('Mark as favorite')}}">
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <a href="#" class="avatar avatar-sm rounded-circle">
                                        <img {{ $comment->user->img_avatar }} data-bs-title="{{ $comment->user->name }}">
                                    </a>
                                </div>
                                <div class="col ml-n2">
        ...
        <div class="modal-footer">
            <div class="col-12 d-flex">
                <div class="pr-3">
                    <img {{ Auth::user()->img_avatar }} data-bs-title="{{ Auth::user()->name }}" class="avatar rounded-circle avatar-sm">
                </div>
