        ...
        <div class="purchase-body">
            <table class="">
                <tbody>
                    <tr>
                        <td>
                            <strong style="display:block;">{{ __('Bill To') }}:</strong>
                        ...
                        @if ($settings['shipping_display'] == 'on')
                            <td class="text-right">
                                <strong style="display:block;">{{ __('Ship To') }}:</strong>
            ...
            <table class="add-border purchase-summary" style="margin-top: 30px;">
                ...
                <tfoot>
                    ...
                    <tr>
                        <td colspan="5"></td>
                        <td colspan="2" class="sub-total" style="padding:0px !important;">
                            <table class="total-table" style="padding:2px !important;">
                                <tr>
                                    <td style="font-weight: bolder; position:relative; top:2px;">{{ __('Subtotal') }}:</td>
                                    <td style="font-weight: bolder; position:relative; top:2px;">{{ Utility::priceFormat($settings, $purchase->getSubTotal()) }}</td>
                                </tr>
                                ...
                                <tr>
                                    <td style="font-weight: bolder; position:relative; top:2px;">{{ __('Due Amount') }}:</td>
                                    <td style="font-weight: bolder; position:relative; top:2px;">{{ Utility::priceFormat($settings, $purchase->getDue()) }}</td>
                                </tr>
            ...
            <div style="margin-top: 40px; margin-bottom: 20px; display: flex; justify-content: space-between;">
