...
">
    ...
    @php $enrollments =$enrollments->sortBy('class_id')->sortBy('section_id')->groupBy('owned_by'); @endphp
        ...
        @foreach ($enrollments as $bra => $enro)
             <tr style="font-weight: 800; border: 2px solid black; background-color: gray;">
                <td colspan="9" style="text-align: left; font-size: 8px; font-weight: 800; font-family: Arial, Helvetica, sans-serif;  border: 2px solid black; background-color: gray;">{{$branches[$bra]}}</td>
            </tr>
            ...
            <tr>
                ...
                <td style="text-align: left; font-size: 8px; font-family: Arial, Helvetica, sans-serif;">{{ @$enrollment->StudentRegistration->phone }}</td>
