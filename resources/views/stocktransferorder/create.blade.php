...
@section('content')
    ...
    <div class="row">
        {{ Form::open(['url' => 'stock-transfer-order', 'class' => 'w-100 stock-transfer-order-ajax-form', 'id' => 'stock-transfer-order-form', 'novalidate' => true]) }}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="branch-box">
                                ...
                                {{ Form::select('branch_id', $branches, $branchId, ['class' => 'form-control select', 'id' => 'branch_id', 'data-url' => route('stock-transfer-order.vender'), 'required' => 'required']) }}
                            </div>
