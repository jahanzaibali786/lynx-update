...
@section('action-btn')
    <div class="float-end">
        <a href="{{ route('contract.index') }}"  data-bs-title="{{__('List View')}}" class="btn btn-sm btn-primary">
                            ...
                            <div class="card-header-right">
                                <div class="btn-group card-option">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="#!" data-size="lg" data-url="{{ route('contract.edit',$contract->id) }}" data-ajax-popup="true" class="dropdown-item" data-bs-title="{{__('Edit User')}}">
