...
@section('action-btn')
    <div class="float-end">
        <a href="{{ route('contract.grid') }}"   data-bs-title="{{__('Grid View')}}" class="btn btn-sm btn-primary">
            <i class="ti ti-layout-grid"></i>
        </a>
        @if(\Auth::user()->type == 'company' || \Auth::user()->type == 'branch')
            <a href="#" data-size="lg" data-url="{{ route('contract.create') }}" data-ajax-popup="true"  data-bs-title="{{__('Create New Contract')}}" class="btn btn-sm btn-primary">
                New ContractCreate
            </a>
            <a href="#" data-size="lg" data-url="{{ route('createvirtualoffice') }}" data-ajax-popup="true"  data-bs-title="{{__('Create New Virtual Office Contract')}}" class="btn btn-sm btn-primary">
                Virtual ContractCreate
            </a>
        @endif
    </div>
@endsection
                    ...
                    <div class="card-body">
                        ...
                        <div class="row d-flex justify-content-end ">
                            ...
                            <div class="col-auto float-end ms-2 mt-4">
                                ...
                                <a href="{{ route('contract.index') }}" class="btn btn-sm btn-danger" 
                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($contracts as $contract)
                                ...
                                <tr class="font-style">
                                    ...
                                    {{--                                    <td>--}}
                                    {{--                                        <a href="#" class="action-item" data-url="{{ route('contract.description',$contract->id) }}" data-ajax-popup="true"  data-bs-title="{{__('Desciption')}}" data-bs-toggle="{{__('Desciption')}}"><i class="fa fa-comment"></i></a>--}}
                                    {{--                                    </td>--}}
                                    ...
                                    <td class="action ">
                                            ...
                                            @if($contract->status=='accept')
                                                <div class="action-btn bg-primary ms-2">
                                                    <a href="#" data-size="lg"
                                                       ...
                                                       data-bs-toggle="{{ __('Copy Contract') }}"
                                                       class="mx-3 btn btn-sm d-inline-flex align-items-center"
                                                        data-bs-placement="top"
                                                       data-bs-title="{{ __('Duplicate') }}"><i
                                        ...
                                        @can('show contract')
                                            <div class="action-btn bg-warning ms-2">
                                                <a href="{{ route('contract.show',\Crypt::encrypt($contract->id)) }}"
                                                   ...
                                                   data-bs-title="{{__('View')}}"> <span class="text-white"> <i class="ti ti-eye"></i></span></a>
                                            </div>
                                            @if($contract->close_date == null)
                                                <div class="action-btn bg-info ms-2">
                                                    <a href="{{ route('contract_status',\Crypt::encrypt($contract->id)) }}" class="mx-3 btn btn-sm d-inline-flex align-items-center"    data-bs-title="{{__('Close Contract')}}" >
                                        ...
                                        @can('edit contract')
                                            <div class="action-btn bg-info ms-2">
                                                <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-url="{{ route('contract.edit',$contract->id) }}" data-ajax-popup="true" data-size="lg"  data-bs-title="{{__('Edit')}}" data-bs-toggle="{{__('Edit Contract')}}">
