...
@section('action-btn')
    <div class="float-end d-flex align-items-center">
        <a href="{{route('contract.download.pdf',\Crypt::encrypt($contract->id))}}" class="btn btn-sm btn-primary btn-icon m-1"  data-bs-placement="top" data-bs-title="{{__('Download')}}" target="_blanks">
            Pdf / Print
        </a>
        <a href="{{ route('get.contract',$contract->id) }}"  target="_blank" class="btn btn-sm btn-primary btn-icon m-1" >
            <i class="ti ti-eye text-white"  data-bs-title="{{ __('PreView') }}"> </i>
        </a>

    @if((\Auth::user()->type=='company'))
       <a href="{{route('send.mail.contract',$contract->id)}}" class="btn btn-sm btn-primary btn-icon m-1"  data-bs-title="{{__('Send Email')}}"  >
           <i class="ti ti-mail text-white"></i>
            ...
            <a href="#" class="btn btn-sm btn-primary btn-icon m-1" data-size="lg" data-url="{{route('contract.copy',$contract->id)}}"
               data-ajax-popup="true"  data-bs-title="{{__('Duplicate')}}" class="btn btn-sm btn-primary">
        ...
        @if((\Auth::user()->type=='company'))
            <a href="#" class="btn btn-sm btn-primary btn-icon m-1" data-size="lg" data-url="{{ route('signature',$contract->id) }}"
               data-ajax-popup="true"  data-bs-toggle="{{__('Add signature')}}" class="btn btn-sm btn-primary">
                                           ...
                                           <div class="action-btn bg-warning ">
                                               <a href="{{$attachments . '/' . $file->files }}"
                                                  ...
                                                  download=""  title="Download">
                                                   <span class="text-white"> Pdf / Print</span>
                                               </a>
                                           </div>
                                               ...
                                               <div class="col-auto actions">
                                                   <div class="action-btn bg-danger">
                                                       ...
                                                       <a href="#!" class="mx-3 btn btn-sm  align-items-center bs-pass-para ">
                                                           <i class="ti ti-trash text-white"  data-bs-title="{{__('Delete')}}" ></i>
                                                       </a>
                                                       {!! Form::close() !!}
                                                   </div>
                                               </div>
