...
@section('action-btn')
    <div class="float-end">
        ...
        @can('edit vender')
            <a href="#" class="btn mx-1 btn-sm btn-outline-primary" data-size="xl" data-url="{{ route('vender.edit',$vendor['id']) }}" data-ajax-popup="true" data-bs-title="{{__('Edit')}}"  data-bs-title="{{__('Edit')}}">
    ...
    <div class="row">
        <div class="col-md-4 col-lg-4 col-xl-4">
            <div class="card pb-0 customer-detail-box vendor_card">
                <div class="card-body">
                    <h3 class="card-title ">{{__('Vendor Info')}}</h3>
