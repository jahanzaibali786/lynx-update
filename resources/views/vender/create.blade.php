...
<div class="modal-body">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                {{Form::label('name',__('Name'),array('class'=>'form-label')) }}<span class="text-danger pl-1"> *</span>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
                {{Form::label('account',__('Account'),array('class'=>'form-label')) }}<span class="text-danger pl-1"> *</span>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
            <div class="form-group">
                {{Form::label('contact',__('Contact'),['class'=>'form-label'])}}<span class="text-danger pl-1"> *</span>
    ...
    <br>
    <br>
    <h6 class="sub-title"><strong>{{__('Billing Address')}}</strong></h6>
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="form-group">
    ...
    @if(App\Models\Utility::getValByName('shipping_display')=='on')
        <div class="col-md-12 text-end">
            <input type="button" id="billing_data" value="{{__('Shipping Same As Billing')}}" class="btn btn-outline-primary">
        </div>
        <h6 class="sub-title"><strong>{{__('Shipping Address')}}</strong></h6>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="form-group">
