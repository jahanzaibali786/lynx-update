    ...
    <div class="row pb-2">
        ...
        <div class="col-6 pt-2">
            <div class="row text-center">
                <div class="col-4"  data-placement="bottom" data-bs-title="{{__('Attachment')}}">
                    <i class="ti ti-paperclip mr-2"></i>{{ count($task->taskFiles) }}
                </div>
                <div class="col-4"  data-placement="bottom" data-bs-title="{{__('Comment')}}">
                    <i class="ti ti-brand-hipchat mr-2"></i>{{ count($task->comments) }}
                </div>
                <div class="col-4"  data-placement="bottom" data-bs-title="{{__('Checklist')}}">
