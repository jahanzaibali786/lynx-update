                            ...
                            <div class="card-list-title row align-items-center mb-3">
                                ...
                                @if((isset($permissions) && in_array('create task',$permissions)))
                                    <div class="col text-end">
                                        <div class="actions">
                                            <a class="action-item mr-2" href="#" data-url="{{ route('projects.tasks.create',[$stage->project_id,$stage->id]) }}" data-ajax-popup="true" data-size="lg" data-bs-toggle="{{__('Add Task in ').$stage->name}}">
                                                Create
                                            </a>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="dropdown action-item">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                @if(isset($permissions) && in_array('edit task',$permissions))
                                                                    <a href="#" data-url="{{ route('projects.tasks.edit',[$project->id,$taskDetail->id]) }}" data-ajax-popup="true" data-size="lg" data-bs-toggle="{{__('Edit ').$taskDetail->name}}" class="dropdown-item">{{ __('Edit') }}</a>
                                                                @endif
                                                ...
                                                <div class="col-7 text-end">
                                                    @if($users = $taskDetail->users())
                                                        <div class="avatar-group">
                                                            @foreach($users as $key => $user)
                                                                @if($key<3)
                                                                    <a href="#" class="avatar rounded-circle avatar-sm">
                                                                        <img data-bs-title="{{(!empty($user)?$user->name:'')}}" @if($user) src="{{asset('/storage/uploads/avatar/'.$user->avatar)}}" @else src="{{asset('/storage/uploads/avatar/avatar.png')}}" @endif style="height:36px;width:36px;">
                                                                    </a>
                                                                @else
                                                                    @break
                                                                @endif
                                                            ...
                                                            @if(count($users) > 3)
                                                                <a href="#" class="avatar rounded-circle avatar-sm">
                                                                    <img data-bs-title="{{(!empty($user)?$user->name:'')}}" @if($user) src="{{asset('/storage/uploads/avatar/'.$user->avatar)}}" @else src="{{asset('/storage/uploads/avatar/avatar.png')}}" @endif>
                                                                </a>
                                                            @endif
                                                        </div>
                                                    @endif
