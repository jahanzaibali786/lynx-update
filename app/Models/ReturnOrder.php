...
class ReturnOrder extends Model
{
    ...
    {
        return $this->hasOne('App\Models\warehouse', 'id', 'customer_id');
    }
    ...
    {
        return $this->hasMany('App\Models\ReturnOrderProduct', 'quotation_id', 'id');
    }

    public function items_approve()
    {
        return $this->hasMany('App\Models\ReturnOrderProduct', 'quotation_id', 'id')->where('status','approved');
    }

    public function items_pending()
    {
        return $this->hasMany('App\Models\ReturnOrderProduct', 'quotation_id', 'id')->where('status','pending');
    }
    ...
    public static function quotationProduct($value , $session_key = 'pos')
    {
        ...
        $id = $value->product_id;
            ...
            $quotationProduct = ReturnOrderProduct::where('product_id',$id)->get();
    ...
    {
        $subTotal = 0;
        foreach($this->items_approve as $product)
        {
    ...
    {
        $subTotal = 0;
        foreach($this->items_pending as $product)
        {
