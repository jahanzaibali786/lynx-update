...
class EmployeeEmploymentHistoryExport implements FromView, WithEvents
{
    protected $data;
    protected $params;
    ...
    {
        $is_branch = true;
        $report_name = "Employee Employment History Report";
        $branchName = $this->data['branchName'];
        return view('employee.reports.employmentHistory_exportExcel', [
            'data' => $this->data,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("B8:D{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setWrapText(true);
                $sheet->getStyle("F8:F{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setWrapText(true);
