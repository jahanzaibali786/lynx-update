...
class Student_defaulterReport implements FromView, WithEvents
{
    protected $branches;
    protected $monthsArray;
    protected $reportData;
    protected $report_name;
    protected $request;
    protected $params;

    public function __construct($branches, $monthsArray, $reportData, $report_name, $request, $params)
    {
    ...
    /**
     * Export the student defaulter data to an Excel view.
     */
    public function view(): View
    {
        ...
        return view('studentReports.exports.student_defaulterreport', [
