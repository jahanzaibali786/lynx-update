...
class EmployeeMonthlyReconsilationExport implements FromView, WithEvents
{
    protected $data;
    protected $params;
    ...
    {
        $is_branch = true;
        $report_name = "Employee Monthly Reconcilation Report";
        $branchName = $this->data['branchName'];
        return view('employee.reports.employeeMonthlyReconsilationExportExcel', [
            'data' => $this->data,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("C8:C{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setWrapText(true);
                $sheet->getStyle("E8:H{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_RIGHT);
                $sheet->getStyle("E8:H{$lastDataRow}")->getNumberFormat()->setFormatCode('#,##0');
