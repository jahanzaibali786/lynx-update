...
class ResignationReportExport implements FromView, WithEvents
{
    ...
    public function __construct($resignations, $branches, $report_name)
    {
    ...
    {
        return view('resignation.excelexport', [
