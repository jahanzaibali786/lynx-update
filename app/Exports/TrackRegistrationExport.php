...
class TrackRegistrationExport implements FromView, WithEvents
{
    protected $students;
    protected $branches;
    protected $classes;
    ...
    public function __construct($students, $branches, $classes, $report_name, $params)
    {
    ...
    {
        return view('studentReports.exports.track_registration', [
     ...
     public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("E8:G{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setWrapText(true);
                ...
                $sheet->getStyle("N8:N{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_RIGHT);
