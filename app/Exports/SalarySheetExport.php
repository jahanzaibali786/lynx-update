...
class SalarySheetExport implements FromView ,WithEvents
{
    ...
    {
        $report_name = __('Salary Sheet Report for the month of ' . date('F Y', mktime(0, 0, 0, $this->requestdata['month'])));
        // Pass only the table-related data to the export view
        return view('employee.exports.salary_sheet', [
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("F9:{$highestColumnLetter}{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_RIGHT);
                $sheet->getStyle("F9:{$highestColumnLetter}{$lastDataRow}")->getNumberFormat()->setFormatCode('#,##0');
