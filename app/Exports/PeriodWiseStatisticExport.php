...
class PeriodWiseStatisticExport implements FromView ,WithEvents
{
    protected $branches;
    protected $data;
    ...
    public function __construct($branches, $data, $selectedBranchId, $branchName, $selectedDate, $report_name, $request, $params){
    ...
    public function view(): View
    {
        ...
        return view('studentReports.exports.period_wise_statistic_reportExcel', [
