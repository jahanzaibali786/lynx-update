...
class AdmissionDetailReportExport implements FromView, WithEvents
{
    ...
    protected $request;
    protected $studentChallanData;
    protected $is_signature;
    protected $branch;
    protected $is_period;


    public function __construct($studentData,$student,$branches,$heads,$classes,$branchTotals,$grandTotal,$request,$studentChallanData)
    {
        ...
        $this->studentChallanData = $studentChallanData;
    }
    /**
    ...
    {
        $branch =  $this->branches ? 'All Branches' : '';
        $is_signature = false;
        $is_period = false;
        $report_name = __('Admission Listing');
        // Pass
        //  only the table-related data to the export view
        return view('student.exports.admissionlisting', [
            ...
            'studentChallanData' => $this->studentChallanData,
            'branch' => $branch,
