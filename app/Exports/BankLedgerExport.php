...
class BankLedgerExport implements FromView, WithColumnFormatting, WithEvents
{
    protected $transfers;
    protected $dateFrom;
    protected $dateTo;
    ...
    public function __construct($transfers, $dateFrom = '', $dateTo = '', $branchName = '')
    {
    ...
    {
        return view('bankAccount.export', [
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $sheet->getStyle("G9:H{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT);
                $sheet->getStyle("I9:I{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_RIGHT);
