...
class ProductStockReportExport implements FromView, WithEvents
{
    ...
    {
        $is_signature = false;
        $report_name = __('Product Stock Report');

        return view('productstock.exports.product_stock_report', [
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("C8:D{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
