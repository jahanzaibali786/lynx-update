...
class StudentReceiptExport implements FromView, WithEvents
{
    protected $receipts;
    protected $params;

    public function __construct($receipts, $params = [])
    {
    ...
    {
        return view('studentReports.exports.studentreceiptexport', [
