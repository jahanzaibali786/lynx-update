...
class DeductionSheetExport implements FromView ,WithEvents
{
    protected $datas;
    protected $selectedMonthYear;


    public function __construct( $datas, $selectedMonthYear)
    {
        $this->datas = $datas;
    ...
    {
        $report_name = __('Deduction Sheet Report for the month of ' . $this->selectedMonthYear);
        // Pass only the table-related data to the export view
        return view('employee.exports.deduction_sheet', [
            'datas' => $this->datas,
