...
class PurchaseProductReportExport implements FromView, WithEvents
{
    protected $data;
    protected $params;
    ...
    public function view(): View
    {
        $is_signature = false;
        $is_period = true;
        $report_name = __('Purchase Product Report');

        return view('purchase.exports.purchase_product_report', [
            'data' => $this->data,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("E10:F{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_RIGHT);
                $sheet->getStyle("E10:F{$lastDataRow}")->getNumberFormat()->setFormatCode('#,##0');
