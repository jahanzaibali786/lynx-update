...
class EmployeeLeaveReportExport implements FromView, WithEvents
{
    protected $data;
    ...
    public function view(): View
    {
        ...
        $is_period = true;
        $is_branch = true;
        $report_name = "Employee Leave Report";
        return view('employee.exports.employee-leave-report-export', [
            'data' => $this->data,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("D10:D{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setWrapText(true);
