...
class AdmissionWithdrawalReport implements FromView, WithEvents
{
    protected $all_data;
    protected $branches;
    ...
    public function __construct($all_data, $branches, $report_name, $params)
    {
    ...
    public function view(): View
    {
        $is_signature = false;
        $is_period = true;
        return view('studentReports.exports.admission_withdrawal_report', [
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("A11:H{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
                $sheet->getStyle("C11:G{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT);
                $sheet->getStyle("Q11:R{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_RIGHT);
                $sheet->getStyle("Q11:R{$lastDataRow}")->getNumberFormat()->setFormatCode('#,##0');
                $sheet->getStyle("S11:S{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT);
