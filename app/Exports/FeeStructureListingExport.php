...
class FeeStructureListingExport implements FromView, WithEvents
{
    protected $class_wise_fee;
    protected $branches;
    protected $request;
    protected $heads;
    protected $params;
    ...
    public function __construct($class_wise_fee, $branchName, $branches, $heads, $report_name, $request, $params)
    {
        $this->class_wise_fee = $class_wise_fee;
    ...
    $is_period = true;
    $is_branch = true;
        return view('student.exports.FeeStructureListingExport', [
            'class_wise_fee' => $this->class_wise_fee,
            'branchName' => $this->branchName->name ?? $this->branchName,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                foreach (range('E', $highestColumnLetter) as $col) {
                    $sheet->getColumnDimension($col)->setWidth(12);
                }
                

                // style col font size 8px and align center
                $sheet->getStyle("A10:{$highestColumnLetter}{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
