...
class PurchaseVendorSummaryExport implements FromView, WithEvents
{
    protected $data;
   ...
   public function view(): View
    {
        ...
        $is_signature = false;
        $is_period = false;
        $report_name = __('Purchase Vendor Summary Report');
        // Pass
        //  only the table-related data to the export view
        return view('student.exports.purchase_vendor_summary', [
            'branch' => $branch,
