...
class SessionBranchWiseReportExport implements FromView, WithDrawings ,WithEvents
{
    protected $branches;
    protected $classes;
    protected $sessions;
    ...
    public function __construct($branches, $sessions,$select_session, $registrationCounts,$strengthCounts, $enrollmentCounts, $withdrawalCounts, $totalRegistrations, $totalEnrollments, $totalWithdrawals, $totalStrength)
    {
    ...
    public function view(): View
    {
        ...
        return view('studentReports.exports.sessionbranchwise', [
