...
class MonthlyStatistics implements FromView ,WithEvents
{
    protected $branches;
    protected $report;
    ...
    public function __construct($branches,$report, $selectedBranchId, $selectedDate, $report_name, $request){
    ...
    public function view(): View
    {
        ...
        return view('studentReports.exports.monthlystatistics', [
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("A8:J{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
