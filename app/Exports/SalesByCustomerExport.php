...
class SalesByCustomerExport implements FromView, WithEvents
{
    protected $data;
    protected $params;
    ...
    public function view(): View
    {
        $is_signature = false;
        $is_period = true;
        $report_name = __('Sales By Customer Report');

        return view('report.exports.sales_by_customer_report', [
            'data' => $this->data,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("C10:D{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
                $sheet->getStyle("B10:B{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setWrapText(true);
                $sheet->getStyle("E10:E{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_RIGHT);
                $sheet->getStyle("E10:E{$lastDataRow}")->getNumberFormat()->setFormatCode('#,##0');
