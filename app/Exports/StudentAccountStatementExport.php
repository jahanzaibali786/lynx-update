    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                //generated by : auth name and on right side generate on date and time
                ...
                $sheet->getStyle("{$highestColumnLetter}{$pageCountRow}")->applyFromArray([
                    'font' => [
                        'italic' => true,
                        'size' => 8,
                        'name' => 'Calibri',
                ...
                $sheet->setCellValue(
                    "{$highestColumnLetter}{$pageCountRow}",
