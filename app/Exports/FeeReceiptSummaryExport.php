...
class FeeReceiptSummaryExport implements FromView, WithEvents
{
    protected $recipts;
    protected $branches;
    ...
    public function __construct($recipts, $branches, $selectedBranch, $report_name, $request, $params)
    {
    ...
    /**
     * Export the student transfer in data to an Excel view.
     */
    public function view(): View
    {
        ...
        return view('student.exports.fee_receipt_summary', [
            'recipts' => $this->recipts,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("B11:{$highestColumnLetter}{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_RIGHT);
