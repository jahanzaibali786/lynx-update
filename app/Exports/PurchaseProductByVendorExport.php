...
class PurchaseProductByVendorExport implements FromView, WithEvents
{
    protected $data;
    protected $params;
    ...
    public function view(): View
    {
        $is_signature = false;
        $is_period = true;
        $report_name = __('Purchase By Vendor Report');

        return view('purchase.exports.purchase_by_vendor_report', [
            'data' => $this->data,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("B10:D{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setWrapText(true);
                $sheet->getStyle("E10:H{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_RIGHT);
                $sheet->getStyle("E10:H{$lastDataRow}")->getNumberFormat()->setFormatCode('#,##0');
