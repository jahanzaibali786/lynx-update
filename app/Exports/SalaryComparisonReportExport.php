...
class SalaryComparisonReportExport implements FromView, WithEvents
{
    protected $processedData;
    protected $displaySessions;
    protected $report_name;
    protected $params;

    public function __construct($processedData, $displaySessions, $report_name, $params)
    {
    ...
    public function view(): \Illuminate\View\View
    {
        $is_signature = false;
        $is_period = true;
        return view('employee.exports.salary-comparison-report', [
            'processedData' => $this->processedData,
            'displaySessions' => $this->displaySessions,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("A9:{$highestColumnLetter}10")->applyFromArray([
                    'font' => [
                        'bold' => true,
                        'size' => 8,
                        'name' => 'calibri',
                ...
                $sheet->getStyle("D11")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setWrapText(true);
                $sheet->getStyle("F11")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setWrapText(true);
                $sheet->getStyle("E11")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setWrapText(true);
                $sheet->getStyle("F11")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setWrapText(true);
                $sheet->getStyle("G11:H{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_RIGHT);
                $sheet->getStyle("G11:H{$lastDataRow}")->getNumberFormat()->setFormatCode('#,##0');
