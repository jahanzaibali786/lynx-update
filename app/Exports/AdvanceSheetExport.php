...
class AdvanceSheetExport implements  FromView ,WithEvents
{
    ...
    public function view(): View
    {
        ...
        $report_name = __('Advance Sheet Report for the month of ' . $selectedMonthYear);
        // Pass only the table-related data to the export view
        return view('employee.exports.advance_sheet', [
