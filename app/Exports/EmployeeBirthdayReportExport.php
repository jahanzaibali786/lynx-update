...
class EmployeeBirthdayReportExport implements FromView, WithEvents
{
    protected $data;
    ...
    {
        $report_name = "Employee Birthday Report";
        return view('employee.reports.employee-birthday-report-exportExcel', [
            'data' => $this->data,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("D8:D{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
