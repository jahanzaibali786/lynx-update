...
{
    // In StudentRegistrationExport.php
    ...
    public function __construct($registrations, $branches, $branchName, $report_name, $params,$branchTotals, $grandTotal)
    {
    ...
    public function view(): View
    {
        ...
        return view('student.exports.registration', [
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $sheet->getStyle("E10:G{$lastDataRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT)->setWrapText(true);
